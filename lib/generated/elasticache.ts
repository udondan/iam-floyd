...
export type ElasticacheActionsTagging = 'AddTagsToResource' | 'RemoveTagsFromResource';
export type ElasticacheActionsWrite = 'AuthorizeCacheSecurityGroupIngress' | 'BatchApplyUpdateAction' | 'BatchStopUpdateAction' | 'CompleteMigration' | 'CopySnapshot' | 'CreateCacheCluster' | 'CreateCacheParameterGroup' | 'CreateCacheSecurityGroup' | 'CreateCacheSubnetGroup' | 'CreateGlobalReplicationGroup' | 'CreateReplicationGroup' | 'CreateSnapshot' | 'CreateUser' | 'CreateUserGroup' | 'DecreaseNodeGroupsInGlobalReplicationGroup' | 'DecreaseReplicaCount' | 'DeleteCacheCluster' | 'DeleteCacheParameterGroup' | 'DeleteCacheSecurityGroup' | 'DeleteCacheSubnetGroup' | 'DeleteGlobalReplicationGroup' | 'DeleteReplicationGroup' | 'DeleteSnapshot' | 'DeleteUser' | 'DeleteUserGroup' | 'DisassociateGlobalReplicationGroup' | 'FailoverGlobalReplicationGroup' | 'IncreaseNodeGroupsInGlobalReplicationGroup' | 'IncreaseReplicaCount' | 'ModifyCacheCluster' | 'ModifyCacheParameterGroup' | 'ModifyCacheSubnetGroup' | 'ModifyGlobalReplicationGroup' | 'ModifyReplicationGroup' | 'ModifyReplicationGroupShardConfiguration' | 'ModifyUser' | 'ModifyUserGroup' | 'PurchaseReservedCacheNodesOffering' | 'RebalanceSlotsInGlobalReplicationGroup' | 'RebootCacheCluster' | 'ResetCacheParameterGroup' | 'RevokeCacheSecurityGroupIngress' | 'StartMigration' | 'TestFailover';
export type ElasticacheActionsList = 'DescribeCacheClusters' | 'DescribeCacheEngineVersions' | 'DescribeCacheParameterGroups' | 'DescribeCacheParameters' | 'DescribeCacheSecurityGroups' | 'DescribeCacheSubnetGroups' | 'DescribeEngineDefaultParameters' | 'DescribeEvents' | 'DescribeGlobalReplicationGroups' | 'DescribeReplicationGroups' | 'DescribeReservedCacheNodes' | 'DescribeReservedCacheNodesOfferings' | 'DescribeServiceUpdates' | 'DescribeSnapshots' | 'DescribeUpdateActions' | 'DescribeUserGroups' | 'DescribeUsers' | 'ListAllowedNodeTypeModifications';
export type ElasticacheActionsRead = 'ListTagsForResource';
export type ElasticacheActions = ElasticacheActionsTagging | ElasticacheActionsWrite | ElasticacheActionsList | ElasticacheActionsRead;
