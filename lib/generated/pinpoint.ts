...
export type MobiletargetingActionsWrite = 'CreateApp' | 'CreateCampaign' | 'CreateEmailTemplate' | 'CreateExportJob' | 'CreateImportJob' | 'CreateJourney' | 'CreatePushTemplate' | 'CreateRecommenderConfiguration' | 'CreateSegment' | 'CreateSmsTemplate' | 'CreateVoiceTemplate' | 'DeleteAdmChannel' | 'DeleteApnsChannel' | 'DeleteApnsSandboxChannel' | 'DeleteApnsVoipChannel' | 'DeleteApnsVoipSandboxChannel' | 'DeleteApp' | 'DeleteBaiduChannel' | 'DeleteCampaign' | 'DeleteEmailChannel' | 'DeleteEmailTemplate' | 'DeleteEndpoint' | 'DeleteEventStream' | 'DeleteGcmChannel' | 'DeleteJourney' | 'DeletePushTemplate' | 'DeleteRecommenderConfiguration' | 'DeleteSegment' | 'DeleteSmsChannel' | 'DeleteSmsTemplate' | 'DeleteUserEndpoints' | 'DeleteVoiceChannel' | 'DeleteVoiceTemplate' | 'PutEventStream' | 'PutEvents' | 'RemoveAttributes' | 'SendMessages' | 'SendUsersMessages' | 'UpdateAdmChannel' | 'UpdateApnsChannel' | 'UpdateApnsSandboxChannel' | 'UpdateApnsVoipChannel' | 'UpdateApnsVoipSandboxChannel' | 'UpdateApplicationSettings' | 'UpdateBaiduChannel' | 'UpdateCampaign' | 'UpdateEmailChannel' | 'UpdateEmailTemplate' | 'UpdateEndpoint' | 'UpdateEndpointsBatch' | 'UpdateGcmChannel' | 'UpdateJourney' | 'UpdateJourneyState' | 'UpdatePushTemplate' | 'UpdateRecommenderConfiguration' | 'UpdateSegment' | 'UpdateSmsChannel' | 'UpdateSmsTemplate' | 'UpdateTemplateActiveVersion' | 'UpdateVoiceChannel' | 'UpdateVoiceTemplate';
export type MobiletargetingActionsRead = 'GetAdmChannel' | 'GetApnsChannel' | 'GetApnsSandboxChannel' | 'GetApnsVoipChannel' | 'GetApnsVoipSandboxChannel' | 'GetApp' | 'GetBaiduChannel' | 'GetCampaign' | 'GetCampaignVersion' | 'GetEmailChannel' | 'GetEmailTemplate' | 'GetEndpoint' | 'GetEventStream' | 'GetExportJob' | 'GetGcmChannel' | 'GetImportJob' | 'GetJourney' | 'GetPushTemplate' | 'GetRecommenderConfiguration' | 'GetSegment' | 'GetSegmentVersion' | 'GetSmsChannel' | 'GetSmsTemplate' | 'GetUserEndpoints' | 'GetVoiceChannel' | 'GetVoiceTemplate' | 'PhoneNumberValidate';
export type MobiletargetingActionsList = 'GetApplicationSettings' | 'GetApps' | 'GetCampaignActivities' | 'GetCampaignVersions' | 'GetCampaigns' | 'GetChannels' | 'GetExportJobs' | 'GetImportJobs' | 'GetRecommenderConfigurations' | 'GetSegmentExportJobs' | 'GetSegmentImportJobs' | 'GetSegmentVersions' | 'GetSegments' | 'ListJourneys' | 'ListTagsForResource' | 'ListTemplateVersions' | 'ListTemplates';
export type MobiletargetingActionsTagging = 'TagResource' | 'UntagResource';
export type MobiletargetingActions = MobiletargetingActionsWrite | MobiletargetingActionsRead | MobiletargetingActionsList | MobiletargetingActionsTagging;
