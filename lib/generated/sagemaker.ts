...
export type SagemakerActionsWrite = 'AddAssociation' | 'AssociateTrialComponent' | 'BatchPutMetrics' | 'CreateAction' | 'CreateAlgorithm' | 'CreateApp' | 'CreateAppImageConfig' | 'CreateArtifact' | 'CreateAutoMLJob' | 'CreateCodeRepository' | 'CreateCompilationJob' | 'CreateContext' | 'CreateDomain' | 'CreateEndpoint' | 'CreateEndpointConfig' | 'CreateExperiment' | 'CreateFeatureGroup' | 'CreateFlowDefinition' | 'CreateHumanTaskUi' | 'CreateHyperParameterTuningJob' | 'CreateImage' | 'CreateImageVersion' | 'CreateLabelingJob' | 'CreateModel' | 'CreateModelPackage' | 'CreateModelPackageGroup' | 'CreateMonitoringSchedule' | 'CreateNotebookInstance' | 'CreateNotebookInstanceLifecycleConfig' | 'CreatePipeline' | 'CreatePresignedDomainUrl' | 'CreatePresignedNotebookInstanceUrl' | 'CreateProcessingJob' | 'CreateProject' | 'CreateTrainingJob' | 'CreateTransformJob' | 'CreateTrial' | 'CreateTrialComponent' | 'CreateUserProfile' | 'CreateWorkforce' | 'CreateWorkteam' | 'DeleteAction' | 'DeleteAlgorithm' | 'DeleteApp' | 'DeleteAppImageConfig' | 'DeleteArtifact' | 'DeleteAssociation' | 'DeleteCodeRepository' | 'DeleteContext' | 'DeleteDomain' | 'DeleteEndpoint' | 'DeleteEndpointConfig' | 'DeleteExperiment' | 'DeleteFeatureGroup' | 'DeleteFlowDefinition' | 'DeleteHumanLoop' | 'DeleteImage' | 'DeleteImageVersion' | 'DeleteModel' | 'DeleteModelPackage' | 'DeleteModelPackageGroup' | 'DeleteModelPackageGroupPolicy' | 'DeleteMonitoringSchedule' | 'DeleteNotebookInstance' | 'DeleteNotebookInstanceLifecycleConfig' | 'DeletePipeline' | 'DeleteProject' | 'DeleteRecord' | 'DeleteTrial' | 'DeleteTrialComponent' | 'DeleteUserProfile' | 'DeleteWorkforce' | 'DeleteWorkteam' | 'DisableSagemakerServicecatalogPortfolio' | 'DisassociateTrialComponent' | 'EnableSagemakerServicecatalogPortfolio' | 'PutModelPackageGroupPolicy' | 'PutRecord' | 'StartHumanLoop' | 'StartMonitoringSchedule' | 'StartNotebookInstance' | 'StartPipelineExecution' | 'StopAutoMLJob' | 'StopCompilationJob' | 'StopHumanLoop' | 'StopHyperParameterTuningJob' | 'StopLabelingJob' | 'StopMonitoringSchedule' | 'StopNotebookInstance' | 'StopPipelineExecution' | 'StopProcessingJob' | 'StopTrainingJob' | 'StopTransformJob' | 'UpdateAction' | 'UpdateAppImageConfig' | 'UpdateArtifact' | 'UpdateCodeRepository' | 'UpdateContext' | 'UpdateDomain' | 'UpdateEndpoint' | 'UpdateEndpointWeightsAndCapacities' | 'UpdateExperiment' | 'UpdateImage' | 'UpdateModelPackage' | 'UpdateMonitoringSchedule' | 'UpdateNotebookInstance' | 'UpdateNotebookInstanceLifecycleConfig' | 'UpdatePipeline' | 'UpdatePipelineExecution' | 'UpdateTrial' | 'UpdateTrialComponent' | 'UpdateUserProfile' | 'UpdateWorkforce' | 'UpdateWorkteam';
export type SagemakerActionsTagging = 'AddTags' | 'DeleteTags';
export type SagemakerActionsRead = 'BatchGetMetrics' | 'DescribeAction' | 'DescribeAlgorithm' | 'DescribeApp' | 'DescribeAppImageConfig' | 'DescribeArtifact' | 'DescribeAutoMLJob' | 'DescribeCodeRepository' | 'DescribeCompilationJob' | 'DescribeContext' | 'DescribeDomain' | 'DescribeEndpoint' | 'DescribeEndpointConfig' | 'DescribeExperiment' | 'DescribeFeatureGroup' | 'DescribeFlowDefinition' | 'DescribeHumanLoop' | 'DescribeHumanTaskUi' | 'DescribeHyperParameterTuningJob' | 'DescribeImage' | 'DescribeImageVersion' | 'DescribeLabelingJob' | 'DescribeModel' | 'DescribeModelPackage' | 'DescribeModelPackageGroup' | 'DescribeMonitoringSchedule' | 'DescribeNotebookInstance' | 'DescribeNotebookInstanceLifecycleConfig' | 'DescribePipeline' | 'DescribePipelineDefinitionForExecution' | 'DescribePipelineExecution' | 'DescribeProcessingJob' | 'DescribeProject' | 'DescribeSubscribedWorkteam' | 'DescribeTrainingJob' | 'DescribeTransformJob' | 'DescribeTrial' | 'DescribeTrialComponent' | 'DescribeUserProfile' | 'DescribeWorkforce' | 'DescribeWorkteam' | 'GetModelPackageGroupPolicy' | 'GetRecord' | 'GetSagemakerServicecatalogPortfolioStatus' | 'GetSearchSuggestions' | 'InvokeEndpoint' | 'RenderUiTemplate' | 'Search';
export type SagemakerActionsList = 'ListActions' | 'ListAlgorithms' | 'ListAppImageConfigs' | 'ListApps' | 'ListArtifacts' | 'ListAssociations' | 'ListAutoMLJobs' | 'ListCandidatesForAutoMLJob' | 'ListCodeRepositories' | 'ListCompilationJobs' | 'ListContexts' | 'ListDomains' | 'ListEndpointConfigs' | 'ListEndpoints' | 'ListExperiments' | 'ListFeatureGroups' | 'ListFlowDefinitions' | 'ListHumanLoops' | 'ListHumanTaskUis' | 'ListHyperParameterTuningJobs' | 'ListImageVersions' | 'ListImages' | 'ListLabelingJobs' | 'ListLabelingJobsForWorkteam' | 'ListModelPackageGroups' | 'ListModelPackages' | 'ListModels' | 'ListMonitoringExecutions' | 'ListMonitoringSchedules' | 'ListNotebookInstanceLifecycleConfigs' | 'ListNotebookInstances' | 'ListPipelineExecutionSteps' | 'ListPipelineExecutions' | 'ListPipelineParametersForExecution' | 'ListPipelines' | 'ListProcessingJobs' | 'ListProjects' | 'ListSubscribedWorkteams' | 'ListTags' | 'ListTrainingJobs' | 'ListTrainingJobsForHyperParameterTuningJob' | 'ListTransformJobs' | 'ListTrialComponents' | 'ListTrials' | 'ListUserProfiles' | 'ListWorkforces' | 'ListWorkteams';
export type SagemakerActions = SagemakerActionsWrite | SagemakerActionsTagging | SagemakerActionsRead | SagemakerActionsList;
