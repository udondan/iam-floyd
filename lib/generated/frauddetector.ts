...
export class Frauddetector extends PolicyStatement {
  ...
  public toUpdateDetectorVersionMetadata() {
    this.to('UpdateDetectorVersionMetadata');
    return this;
  }
  ...
  public toUpdateModelVersionStatus() {
    this.to('UpdateModelVersionStatus');
    return this;
  }
