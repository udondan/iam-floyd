...
export type WorkmailActionsWrite = 'AddMembersToGroup' | 'AssociateDelegateToResource' | 'AssociateMemberToGroup' | 'CancelMailboxExportJob' | 'CreateAlias' | 'CreateGroup' | 'CreateInboundMailFlowRule' | 'CreateMailDomain' | 'CreateMailUser' | 'CreateOrganization' | 'CreateOutboundMailFlowRule' | 'CreateResource' | 'CreateSmtpGateway' | 'CreateUser' | 'DeleteAccessControlRule' | 'DeleteAlias' | 'DeleteGroup' | 'DeleteInboundMailFlowRule' | 'DeleteMailDomain' | 'DeleteMailboxPermissions' | 'DeleteMobileDevice' | 'DeleteOrganization' | 'DeleteOutboundMailFlowRule' | 'DeleteResource' | 'DeleteRetentionPolicy' | 'DeleteSmtpGateway' | 'DeleteUser' | 'DeregisterFromWorkMail' | 'DisableMailGroups' | 'DisableMailUsers' | 'DisassociateDelegateFromResource' | 'DisassociateMemberFromGroup' | 'EnableMailDomain' | 'EnableMailGroups' | 'EnableMailUsers' | 'PutAccessControlRule' | 'PutMailboxPermissions' | 'PutRetentionPolicy' | 'RegisterToWorkMail' | 'RemoveMembersFromGroup' | 'ResetPassword' | 'ResetUserPassword' | 'SetAdmin' | 'SetDefaultMailDomain' | 'SetJournalingRules' | 'SetMailGroupDetails' | 'SetMailUserDetails' | 'SetMobilePolicyDetails' | 'StartMailboxExportJob' | 'TestInboundMailFlowRules' | 'TestOutboundMailFlowRules' | 'UpdateInboundMailFlowRule' | 'UpdateMailboxQuota' | 'UpdateOutboundMailFlowRule' | 'UpdatePrimaryEmailAddress' | 'UpdateResource' | 'UpdateSmtpGateway' | 'WipeMobileDevice';
export type WorkmailActionsList = 'DescribeDirectories' | 'DescribeGroup' | 'DescribeKmsKeys' | 'DescribeMailDomains' | 'DescribeMailGroups' | 'DescribeMailUsers' | 'DescribeOrganization' | 'DescribeOrganizations' | 'DescribeResource' | 'DescribeUser' | 'ListAccessControlRules' | 'ListAliases' | 'ListGroupMembers' | 'ListGroups' | 'ListInboundMailFlowRules' | 'ListMailboxExportJobs' | 'ListMailboxPermissions' | 'ListOrganizations' | 'ListOutboundMailFlowRules' | 'ListResourceDelegates' | 'ListResources' | 'ListSmtpGateways' | 'ListTagsForResource' | 'ListUsers';
export type WorkmailActionsRead = 'DescribeInboundMailFlowRule' | 'DescribeMailboxExportJob' | 'DescribeOutboundMailFlowRule' | 'DescribeSmtpGateway' | 'GetAccessControlEffect' | 'GetDefaultRetentionPolicy' | 'GetJournalingRules' | 'GetMailDomainDetails' | 'GetMailGroupDetails' | 'GetMailUserDetails' | 'GetMailboxDetails' | 'GetMobileDeviceDetails' | 'GetMobileDevicesForUser' | 'GetMobilePolicyDetails' | 'ListMembersInMailGroup' | 'SearchMembers';
export type WorkmailActionsTagging = 'TagResource' | 'UntagResource';
export type WorkmailActions = WorkmailActionsWrite | WorkmailActionsList | WorkmailActionsRead | WorkmailActionsTagging;
