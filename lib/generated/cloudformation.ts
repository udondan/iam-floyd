...
export type CloudformationActionsPermissionsManagement = 'SetStackPolicy';
export type CloudformationActionsTagging = 'TagResource' | 'UntagResource';
export type CloudformationActions = CloudformationActionsWrite | CloudformationActionsRead | CloudformationActionsList | CloudformationActionsPermissionsManagement | CloudformationActionsTagging;
