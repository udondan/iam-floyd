...
export class Ssm extends PolicyStatement {
  ...
  protected actionList: Actions = {
    ...
    CreateDocument: {
      ...
      conditions: ['aws:RequestTag/${TagKey}', 'aws:TagKeys'],
    },
    ...
    DeleteParameter: {
      ...
      conditions: ['aws:RequestTag/${TagKey}'],
    },
    DeleteParameters: {
      url:
    ...
    SendCommand: {
      ...
      conditions: ['aws:ResourceTag/${TagKey}', 'ssm:resourceTag/tag-key'],
    },
    ...
    StartSession: {
      ...
      conditions: ['ssm:SessionDocumentAccessCheck'],
    },
  ...
  protected resourceTypes: ResourceTypes = {
    ...
    document: {
      ...
      conditionKeys: ['aws:ResourceTag/${TagKey}', 'ssm:resourceTag/tag-key'],
    },
    instance: {
      name: 'instance',
      url:
   ...
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`.
   */
  public onManagedInstanceInventory(
    instanceId: string,
    account?: string,
    region?: string,
    partition?: string
   ...
   */
  public onParameter(
    fullyQualifiedParameterName: string,
    account?: string,
    region?: string,
    partition?: string
  ) {
