...
export type ConnectActionsWrite = 'AssociateApprovedOrigin' | 'AssociateInstanceStorageConfig' | 'AssociateLambdaFunction' | 'AssociateLexBot' | 'AssociateRoutingProfileQueues' | 'AssociateSecurityKey' | 'CreateContactFlow' | 'CreateInstance' | 'CreateRoutingProfile' | 'CreateUser' | 'CreateUserHierarchyGroup' | 'DeleteInstance' | 'DeleteUser' | 'DeleteUserHierarchyGroup' | 'DestroyInstance' | 'DisassociateApprovedOrigin' | 'DisassociateInstanceStorageConfig' | 'DisassociateLambdaFunction' | 'DisassociateLexBot' | 'DisassociateRoutingProfileQueues' | 'DisassociateSecurityKey' | 'GetFederationTokens' | 'ModifyInstance' | 'ResumeContactRecording' | 'StartChatContact' | 'StartContactRecording' | 'StartOutboundVoiceContact' | 'StartTaskContact' | 'StopContact' | 'StopContactRecording' | 'SuspendContactRecording' | 'UpdateContactAttributes' | 'UpdateContactFlowContent' | 'UpdateContactFlowName' | 'UpdateInstanceAttribute' | 'UpdateInstanceStorageConfig' | 'UpdateRoutingProfileConcurrency' | 'UpdateRoutingProfileDefaultOutboundQueue' | 'UpdateRoutingProfileName' | 'UpdateRoutingProfileQueues' | 'UpdateUserHierarchy' | 'UpdateUserHierarchyGroupName' | 'UpdateUserHierarchyStructure' | 'UpdateUserIdentityInfo' | 'UpdateUserPhoneConfig' | 'UpdateUserRoutingProfile' | 'UpdateUserSecurityProfiles';
export type ConnectActionsRead = 'DescribeContactFlow' | 'DescribeInstance' | 'DescribeInstanceAttribute' | 'DescribeInstanceStorageConfig' | 'DescribeRoutingProfile' | 'DescribeUser' | 'DescribeUserHierarchyGroup' | 'DescribeUserHierarchyStructure' | 'GetContactAttributes' | 'GetCurrentMetricData' | 'GetFederationToken' | 'GetMetricData' | 'ListRoutingProfileQueues' | 'ListTagsForResource';
export type ConnectActionsList = 'ListApprovedOrigins' | 'ListContactFlows' | 'ListHoursOfOperations' | 'ListInstanceAttributes' | 'ListInstanceStorageConfigs' | 'ListInstances' | 'ListLambdaFunctions' | 'ListLexBots' | 'ListPhoneNumbers' | 'ListPrompts' | 'ListQueues' | 'ListRoutingProfiles' | 'ListSecurityKeys' | 'ListSecurityProfiles' | 'ListUserHierarchyGroups' | 'ListUsers';
export type ConnectActionsTagging = 'TagResource' | 'UntagResource';
export type ConnectActions = ConnectActionsWrite | ConnectActionsRead | ConnectActionsList | ConnectActionsTagging;
