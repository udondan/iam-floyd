...
export type ComprehendActionsRead = 'BatchDetectDominantLanguage' | 'BatchDetectEntities' | 'BatchDetectKeyPhrases' | 'BatchDetectSentiment' | 'BatchDetectSyntax' | 'ClassifyDocument' | 'DescribeDocumentClassificationJob' | 'DescribeDocumentClassifier' | 'DescribeDominantLanguageDetectionJob' | 'DescribeEndpoint' | 'DescribeEntitiesDetectionJob' | 'DescribeEntityRecognizer' | 'DescribeEventsDetectionJob' | 'DescribeKeyPhrasesDetectionJob' | 'DescribePiiEntitiesDetectionJob' | 'DescribeSentimentDetectionJob' | 'DescribeTopicsDetectionJob' | 'DetectDominantLanguage' | 'DetectEntities' | 'DetectKeyPhrases' | 'DetectPiiEntities' | 'DetectSentiment' | 'DetectSyntax';
export type ComprehendActionsWrite = 'CreateDocumentClassifier' | 'CreateEndpoint' | 'CreateEntityRecognizer' | 'DeleteDocumentClassifier' | 'DeleteEndpoint' | 'DeleteEntityRecognizer' | 'StartDocumentClassificationJob' | 'StartDominantLanguageDetectionJob' | 'StartEntitiesDetectionJob' | 'StartEventsDetectionJob' | 'StartKeyPhrasesDetectionJob' | 'StartPiiEntitiesDetectionJob' | 'StartSentimentDetectionJob' | 'StartTopicsDetectionJob' | 'StopDominantLanguageDetectionJob' | 'StopEntitiesDetectionJob' | 'StopEventsDetectionJob' | 'StopKeyPhrasesDetectionJob' | 'StopPiiEntitiesDetectionJob' | 'StopSentimentDetectionJob' | 'StopTrainingDocumentClassifier' | 'StopTrainingEntityRecognizer' | 'UpdateEndpoint';
export type ComprehendActionsList = 'ListDocumentClassificationJobs' | 'ListDocumentClassifiers' | 'ListDominantLanguageDetectionJobs' | 'ListEndpoints' | 'ListEntitiesDetectionJobs' | 'ListEntityRecognizers' | 'ListEventsDetectionJobs' | 'ListKeyPhrasesDetectionJobs' | 'ListPiiEntitiesDetectionJobs' | 'ListSentimentDetectionJobs' | 'ListTagsForResource' | 'ListTopicsDetectionJobs';
export type ComprehendActionsTagging = 'TagResource' | 'UntagResource';
export type ComprehendActions = ComprehendActionsRead | ComprehendActionsWrite | ComprehendActionsList | ComprehendActionsTagging;
