...
export type DirectconnectActionsWrite = 'AcceptDirectConnectGatewayAssociationProposal' | 'AllocateConnectionOnInterconnect' | 'AllocateHostedConnection' | 'AllocatePrivateVirtualInterface' | 'AllocatePublicVirtualInterface' | 'AllocateTransitVirtualInterface' | 'AssociateConnectionWithLag' | 'AssociateHostedConnection' | 'AssociateVirtualInterface' | 'ConfirmConnection' | 'ConfirmPrivateVirtualInterface' | 'ConfirmPublicVirtualInterface' | 'ConfirmTransitVirtualInterface' | 'CreateBGPPeer' | 'CreateConnection' | 'CreateDirectConnectGateway' | 'CreateDirectConnectGatewayAssociation' | 'CreateDirectConnectGatewayAssociationProposal' | 'CreateInterconnect' | 'CreateLag' | 'CreatePrivateVirtualInterface' | 'CreatePublicVirtualInterface' | 'CreateTransitVirtualInterface' | 'DeleteBGPPeer' | 'DeleteConnection' | 'DeleteDirectConnectGateway' | 'DeleteDirectConnectGatewayAssociation' | 'DeleteDirectConnectGatewayAssociationProposal' | 'DeleteInterconnect' | 'DeleteLag' | 'DeleteVirtualInterface' | 'DisassociateConnectionFromLag' | 'StartBgpFailoverTest' | 'StopBgpFailoverTest' | 'UpdateDirectConnectGatewayAssociation' | 'UpdateLag' | 'UpdateVirtualInterfaceAttributes';
export type DirectconnectActionsRead = 'DescribeConnectionLoa' | 'DescribeConnections' | 'DescribeConnectionsOnInterconnect' | 'DescribeDirectConnectGatewayAssociationProposals' | 'DescribeDirectConnectGatewayAssociations' | 'DescribeDirectConnectGatewayAttachments' | 'DescribeDirectConnectGateways' | 'DescribeHostedConnections' | 'DescribeInterconnectLoa' | 'DescribeInterconnects' | 'DescribeLags' | 'DescribeLoa' | 'DescribeTags' | 'DescribeVirtualGateways' | 'DescribeVirtualInterfaces';
export type DirectconnectActionsList = 'DescribeLocations' | 'ListVirtualInterfaceTestHistory';
export type DirectconnectActionsTagging = 'TagResource' | 'UntagResource';
export type DirectconnectActions = DirectconnectActionsWrite | DirectconnectActionsRead | DirectconnectActionsList | DirectconnectActionsTagging;
