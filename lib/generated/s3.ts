...
export type S3ActionsPermissionsManagement = 'BypassGovernanceRetention' | 'DeleteAccessPointPolicy' | 'DeleteBucketPolicy' | 'ObjectOwnerOverrideToBucketOwner' | 'PutAccessPointPolicy' | 'PutAccountPublicAccessBlock' | 'PutBucketAcl' | 'PutBucketPolicy' | 'PutBucketPublicAccessBlock' | 'PutObjectAcl' | 'PutObjectVersionAcl';
...
export type S3Actions = S3ActionsWrite | S3ActionsPermissionsManagement | S3ActionsTagging | S3ActionsRead | S3ActionsList;
