...
export type S3ActionsWrite = 'AbortMultipartUpload' | 'CreateAccessPoint' | 'CreateBucket' | 'CreateJob' | 'DeleteAccessPoint' | 'DeleteBucket' | 'DeleteBucketOwnershipControls' | 'DeleteBucketWebsite' | 'DeleteObject' | 'DeleteObjectVersion' | 'DeleteStorageLensConfiguration' | 'PutAccelerateConfiguration' | 'PutAnalyticsConfiguration' | 'PutBucketCORS' | 'PutBucketLogging' | 'PutBucketNotification' | 'PutBucketObjectLockConfiguration' | 'PutBucketOwnershipControls' | 'PutBucketRequestPayment' | 'PutBucketVersioning' | 'PutBucketWebsite' | 'PutEncryptionConfiguration' | 'PutInventoryConfiguration' | 'PutLifecycleConfiguration' | 'PutMetricsConfiguration' | 'PutObject' | 'PutObjectLegalHold' | 'PutObjectRetention' | 'PutReplicationConfiguration' | 'PutStorageLensConfiguration' | 'ReplicateDelete' | 'ReplicateObject' | 'RestoreObject' | 'UpdateJobPriority' | 'UpdateJobStatus';
export type S3ActionsPermissions management = 'BypassGovernanceRetention' | 'DeleteAccessPointPolicy' | 'DeleteBucketPolicy' | 'ObjectOwnerOverrideToBucketOwner' | 'PutAccessPointPolicy' | 'PutAccountPublicAccessBlock' | 'PutBucketAcl' | 'PutBucketPolicy' | 'PutBucketPublicAccessBlock' | 'PutObjectAcl' | 'PutObjectVersionAcl';

export type S3ActionsTagging = 'DeleteJobTagging' | 'DeleteObjectTagging' | 'DeleteObjectVersionTagging' | 'DeleteStorageLensConfigurationTagging' | 'PutBucketTagging' | 'PutJobTagging' | 'PutObjectTagging' | 'PutObjectVersionTagging' | 'PutStorageLensConfigurationTagging' | 'ReplicateTags';
export type S3ActionsRead = 'DescribeJob' | 'GetAccelerateConfiguration' | 'GetAccessPoint' | 'GetAccessPointPolicy' | 'GetAccessPointPolicyStatus' | 'GetAccountPublicAccessBlock' | 'GetAnalyticsConfiguration' | 'GetBucketAcl' | 'GetBucketCORS' | 'GetBucketLocation' | 'GetBucketLogging' | 'GetBucketNotification' | 'GetBucketObjectLockConfiguration' | 'GetBucketOwnershipControls' | 'GetBucketPolicy' | 'GetBucketPolicyStatus' | 'GetBucketPublicAccessBlock' | 'GetBucketRequestPayment' | 'GetBucketTagging' | 'GetBucketVersioning' | 'GetBucketWebsite' | 'GetEncryptionConfiguration' | 'GetInventoryConfiguration' | 'GetJobTagging' | 'GetLifecycleConfiguration' | 'GetMetricsConfiguration' | 'GetObject' | 'GetObjectAcl' | 'GetObjectLegalHold' | 'GetObjectRetention' | 'GetObjectTagging' | 'GetObjectTorrent' | 'GetObjectVersion' | 'GetObjectVersionAcl' | 'GetObjectVersionForReplication' | 'GetObjectVersionTagging' | 'GetObjectVersionTorrent' | 'GetReplicationConfiguration' | 'GetStorageLensConfiguration' | 'GetStorageLensConfigurationTagging' | 'GetStorageLensDashboard' | 'ListAccessPoints';
export type S3ActionsList = 'ListAllMyBuckets' | 'ListBucket' | 'ListBucketMultipartUploads' | 'ListBucketVersions' | 'ListJobs' | 'ListMultipartUploadParts' | 'ListStorageLensConfigurations';
export type S3Actions = S3ActionsWrite | S3ActionsPermissions management | S3ActionsTagging | S3ActionsRead | S3ActionsList;
