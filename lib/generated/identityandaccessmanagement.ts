...
export type IamActionsPermissionsManagement = 'AttachGroupPolicy' | 'AttachRolePolicy' | 'AttachUserPolicy' | 'CreatePolicy' | 'CreatePolicyVersion' | 'DeleteAccountPasswordPolicy' | 'DeleteGroupPolicy' | 'DeletePolicy' | 'DeletePolicyVersion' | 'DeleteRolePermissionsBoundary' | 'DeleteRolePolicy' | 'DeleteUserPermissionsBoundary' | 'DeleteUserPolicy' | 'DetachGroupPolicy' | 'DetachRolePolicy' | 'DetachUserPolicy' | 'PutGroupPolicy' | 'PutRolePermissionsBoundary' | 'PutRolePolicy' | 'PutUserPermissionsBoundary' | 'PutUserPolicy' | 'SetDefaultPolicyVersion' | 'UpdateAssumeRolePolicy';
...
export type IamActions = IamActionsWrite | IamActionsPermissionsManagement | IamActionsRead | IamActionsList | IamActionsTagging;
