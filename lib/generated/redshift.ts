...
export type RedshiftActionsPermissionsManagement = 'AuthorizeClusterSecurityGroupIngress' | 'AuthorizeSnapshotAccess' | 'CreateClusterUser' | 'CreateSnapshotCopyGrant' | 'JoinGroup' | 'ModifyClusterIamRoles' | 'RevokeClusterSecurityGroupIngress' | 'RevokeSnapshotAccess' | 'RotateEncryptionKey';
...
export type RedshiftActions = RedshiftActionsWrite | RedshiftActionsPermissionsManagement | RedshiftActionsTagging | RedshiftActionsRead | RedshiftActionsList;
