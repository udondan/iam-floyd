...
export type RedshiftActionsWrite = 'AcceptReservedNodeExchange' | 'BatchDeleteClusterSnapshots' | 'BatchModifyClusterSnapshots' | 'CancelQuery' | 'CancelQuerySession' | 'CancelResize' | 'CopyClusterSnapshot' | 'CreateCluster' | 'CreateClusterParameterGroup' | 'CreateClusterSecurityGroup' | 'CreateClusterSnapshot' | 'CreateClusterSubnetGroup' | 'CreateEventSubscription' | 'CreateHsmClientCertificate' | 'CreateHsmConfiguration' | 'CreateSavedQuery' | 'CreateScheduledAction' | 'CreateSnapshotSchedule' | 'DeleteCluster' | 'DeleteClusterParameterGroup' | 'DeleteClusterSecurityGroup' | 'DeleteClusterSnapshot' | 'DeleteClusterSubnetGroup' | 'DeleteEventSubscription' | 'DeleteHsmClientCertificate' | 'DeleteHsmConfiguration' | 'DeleteSavedQueries' | 'DeleteScheduledAction' | 'DeleteSnapshotCopyGrant' | 'DeleteSnapshotSchedule' | 'DisableLogging' | 'DisableSnapshotCopy' | 'EnableLogging' | 'EnableSnapshotCopy' | 'ExecuteQuery' | 'GetClusterCredentials' | 'ModifyCluster' | 'ModifyClusterDbRevision' | 'ModifyClusterMaintenance' | 'ModifyClusterParameterGroup' | 'ModifyClusterSnapshot' | 'ModifyClusterSnapshotSchedule' | 'ModifyClusterSubnetGroup' | 'ModifyEventSubscription' | 'ModifySavedQuery' | 'ModifyScheduledAction' | 'ModifySnapshotCopyRetentionPeriod' | 'ModifySnapshotSchedule' | 'PauseCluster' | 'PurchaseReservedNodeOffering' | 'RebootCluster' | 'ResetClusterParameterGroup' | 'ResizeCluster' | 'RestoreFromClusterSnapshot' | 'RestoreTableFromClusterSnapshot' | 'ResumeCluster';
export type RedshiftActionsPermissions management = 'AuthorizeClusterSecurityGroupIngress' | 'AuthorizeSnapshotAccess' | 'CreateClusterUser' | 'CreateSnapshotCopyGrant' | 'JoinGroup' | 'ModifyClusterIamRoles' | 'RevokeClusterSecurityGroupIngress' | 'RevokeSnapshotAccess' | 'RotateEncryptionKey';

export type RedshiftActionsTagging = 'CreateTags' | 'DeleteTags';
export type RedshiftActionsRead = 'DescribeAccountAttributes' | 'DescribeClusterParameterGroups' | 'DescribeClusterParameters' | 'DescribeClusterSecurityGroups' | 'DescribeClusterSnapshots' | 'DescribeClusterSubnetGroups' | 'DescribeClusterVersions' | 'DescribeDefaultClusterParameters' | 'DescribeEventCategories' | 'DescribeEventSubscriptions' | 'DescribeHsmClientCertificates' | 'DescribeHsmConfigurations' | 'DescribeLoggingStatus' | 'DescribeOrderableClusterOptions' | 'DescribeQuery' | 'DescribeReservedNodeOfferings' | 'DescribeReservedNodes' | 'DescribeResize' | 'DescribeSavedQueries' | 'DescribeScheduledActions' | 'DescribeSnapshotCopyGrants' | 'DescribeSnapshotSchedules' | 'DescribeStorage' | 'DescribeTable' | 'DescribeTableRestoreStatus' | 'DescribeTags' | 'FetchResults' | 'GetReservedNodeExchangeOfferings';
export type RedshiftActionsList = 'DescribeClusterDbRevisions' | 'DescribeClusterTracks' | 'DescribeClusters' | 'DescribeEvents' | 'DescribeNodeConfigurationOptions' | 'ListDatabases' | 'ListSavedQueries' | 'ListSchemas' | 'ListTables' | 'ViewQueriesFromConsole' | 'ViewQueriesInConsole';
export type RedshiftActions = RedshiftActionsWrite | RedshiftActionsPermissions management | RedshiftActionsTagging | RedshiftActionsRead | RedshiftActionsList;
