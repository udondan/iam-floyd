...
export type OpsworksActionsWrite = 'AssignInstance' | 'AssignVolume' | 'AssociateElasticIp' | 'AttachElasticLoadBalancer' | 'CloneStack' | 'CreateApp' | 'CreateDeployment' | 'CreateInstance' | 'CreateLayer' | 'CreateStack' | 'CreateUserProfile' | 'DeleteApp' | 'DeleteInstance' | 'DeleteLayer' | 'DeleteStack' | 'DeleteUserProfile' | 'DeregisterEcsCluster' | 'DeregisterElasticIp' | 'DeregisterInstance' | 'DeregisterRdsDbInstance' | 'DeregisterVolume' | 'DetachElasticLoadBalancer' | 'DisassociateElasticIp' | 'GrantAccess' | 'RebootInstance' | 'RegisterEcsCluster' | 'RegisterElasticIp' | 'RegisterInstance' | 'RegisterRdsDbInstance' | 'RegisterVolume' | 'SetLoadBasedAutoScaling' | 'SetTimeBasedAutoScaling' | 'StartInstance' | 'StartStack' | 'StopInstance' | 'StopStack' | 'TagResource' | 'UnassignInstance' | 'UnassignVolume' | 'UntagResource' | 'UpdateApp' | 'UpdateElasticIp' | 'UpdateInstance' | 'UpdateLayer' | 'UpdateMyUserProfile' | 'UpdateRdsDbInstance' | 'UpdateStack' | 'UpdateVolume';
export type OpsworksActionsList = 'DescribeAgentVersions' | 'DescribeApps' | 'DescribeCommands' | 'DescribeDeployments' | 'DescribeEcsClusters' | 'DescribeElasticIps' | 'DescribeElasticLoadBalancers' | 'DescribeInstances' | 'DescribeLayers' | 'DescribeLoadBasedAutoScaling' | 'DescribeMyUserProfile' | 'DescribePermissions' | 'DescribeRaidArrays' | 'DescribeRdsDbInstances' | 'DescribeServiceErrors' | 'DescribeStackProvisioningParameters' | 'DescribeStackSummary' | 'DescribeStacks' | 'DescribeTimeBasedAutoScaling' | 'DescribeUserProfiles' | 'DescribeVolumes' | 'ListTags';
export type OpsworksActionsRead = 'GetHostnameSuggestion';
export type OpsworksActionsPermissions management = 'SetPermission' | 'UpdateUserProfile';

export type OpsworksActions = OpsworksActionsWrite | OpsworksActionsList | OpsworksActionsRead | OpsworksActionsPermissions management;
