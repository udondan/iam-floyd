...
export type CloudfrontActionsWrite = 'CreateCachePolicy' | 'CreateCloudFrontOriginAccessIdentity' | 'CreateDistribution' | 'CreateFieldLevelEncryptionConfig' | 'CreateFieldLevelEncryptionProfile' | 'CreateInvalidation' | 'CreateOriginRequestPolicy' | 'CreatePublicKey' | 'CreateStreamingDistribution' | 'DeleteCachePolicy' | 'DeleteCloudFrontOriginAccessIdentity' | 'DeleteDistribution' | 'DeleteFieldLevelEncryptionConfig' | 'DeleteFieldLevelEncryptionProfile' | 'DeleteOriginRequestPolicy' | 'DeletePublicKey' | 'DeleteStreamingDistribution' | 'UpdateCachePolicy' | 'UpdateCloudFrontOriginAccessIdentity' | 'UpdateDistribution' | 'UpdateFieldLevelEncryptionConfig' | 'UpdateFieldLevelEncryptionProfile' | 'UpdateOriginRequestPolicy' | 'UpdatePublicKey' | 'UpdateStreamingDistribution';
export type CloudfrontActionsTagging = 'CreateDistributionWithTags' | 'CreateStreamingDistributionWithTags' | 'TagResource' | 'UntagResource';
export type CloudfrontActionsRead = 'GetCachePolicy' | 'GetCachePolicyConfig' | 'GetCloudFrontOriginAccessIdentity' | 'GetCloudFrontOriginAccessIdentityConfig' | 'GetDistribution' | 'GetDistributionConfig' | 'GetFieldLevelEncryption' | 'GetFieldLevelEncryptionConfig' | 'GetFieldLevelEncryptionProfile' | 'GetFieldLevelEncryptionProfileConfig' | 'GetInvalidation' | 'GetOriginRequestPolicy' | 'GetOriginRequestPolicyConfig' | 'GetPublicKey' | 'GetPublicKeyConfig' | 'GetStreamingDistribution' | 'GetStreamingDistributionConfig' | 'ListTagsForResource';
export type CloudfrontActionsList = 'ListCachePolicies' | 'ListCloudFrontOriginAccessIdentities' | 'ListDistributions' | 'ListDistributionsByCachePolicyId' | 'ListDistributionsByOriginRequestPolicyId' | 'ListDistributionsByWebACLId' | 'ListFieldLevelEncryptionConfigs' | 'ListFieldLevelEncryptionProfiles' | 'ListInvalidations' | 'ListOriginRequestPolicies' | 'ListPublicKeys' | 'ListStreamingDistributions';
export type CloudfrontActions = CloudfrontActionsWrite | CloudfrontActionsTagging | CloudfrontActionsRead | CloudfrontActionsList;
