...
export type ChimeActionsWrite = 'AcceptDelegate' | 'ActivateUsers' | 'AddDomain' | 'AddOrUpdateGroups' | 'AssociatePhoneNumberWithUser' | 'AssociatePhoneNumbersWithVoiceConnector' | 'AssociatePhoneNumbersWithVoiceConnectorGroup' | 'AssociateSigninDelegateGroupsWithAccount' | 'AuthorizeDirectory' | 'BatchCreateAttendee' | 'BatchCreateRoomMembership' | 'BatchDeletePhoneNumber' | 'BatchSuspendUser' | 'BatchUnsuspendUser' | 'BatchUpdatePhoneNumber' | 'BatchUpdateUser' | 'ConnectDirectory' | 'CreateAccount' | 'CreateApiKey' | 'CreateAttendee' | 'CreateBot' | 'CreateBotMembership' | 'CreateCDRBucket' | 'CreateMeeting' | 'CreateMeetingDialOut' | 'CreateMeetingWithAttendees' | 'CreatePhoneNumberOrder' | 'CreateProxySession' | 'CreateRoom' | 'CreateRoomMembership' | 'CreateSipMediaApplication' | 'CreateSipMediaApplicationCall' | 'CreateSipRule' | 'CreateUser' | 'CreateVoiceConnector' | 'CreateVoiceConnectorGroup' | 'DeleteAccount' | 'DeleteAccountOpenIdConfig' | 'DeleteApiKey' | 'DeleteAttendee' | 'DeleteCDRBucket' | 'DeleteDelegate' | 'DeleteDomain' | 'DeleteEventsConfiguration' | 'DeleteGroups' | 'DeleteMeeting' | 'DeletePhoneNumber' | 'DeleteProxySession' | 'DeleteRoom' | 'DeleteRoomMembership' | 'DeleteSipMediaApplication' | 'DeleteSipRule' | 'DeleteVoiceConnector' | 'DeleteVoiceConnectorEmergencyCallingConfiguration' | 'DeleteVoiceConnectorGroup' | 'DeleteVoiceConnectorOrigination' | 'DeleteVoiceConnectorProxy' | 'DeleteVoiceConnectorStreamingConfiguration' | 'DeleteVoiceConnectorTermination' | 'DeleteVoiceConnectorTerminationCredentials' | 'DisassociatePhoneNumberFromUser' | 'DisassociatePhoneNumbersFromVoiceConnector' | 'DisassociatePhoneNumbersFromVoiceConnectorGroup' | 'DisassociateSigninDelegateGroupsFromAccount' | 'DisconnectDirectory' | 'InviteDelegate' | 'InviteUsers' | 'InviteUsersFromProvider' | 'LogoutUser' | 'PutEventsConfiguration' | 'PutRetentionSettings' | 'PutSipMediaApplicationLoggingConfiguration' | 'PutVoiceConnectorEmergencyCallingConfiguration' | 'PutVoiceConnectorLoggingConfiguration' | 'PutVoiceConnectorOrigination' | 'PutVoiceConnectorProxy' | 'PutVoiceConnectorStreamingConfiguration' | 'PutVoiceConnectorTermination' | 'PutVoiceConnectorTerminationCredentials' | 'RedactConversationMessage' | 'RedactRoomMessage' | 'RegenerateSecurityToken' | 'RenameAccount' | 'RenewDelegate' | 'ResetAccountResource' | 'ResetPersonalPIN' | 'RestorePhoneNumber' | 'StartDataExport' | 'SubmitSupportRequest' | 'SuspendUsers' | 'UnauthorizeDirectory' | 'UpdateAccount' | 'UpdateAccountOpenIdConfig' | 'UpdateAccountResource' | 'UpdateAccountSettings' | 'UpdateBot' | 'UpdateCDRSettings' | 'UpdateGlobalSettings' | 'UpdatePhoneNumber' | 'UpdatePhoneNumberSettings' | 'UpdateProxySession' | 'UpdateRoom' | 'UpdateRoomMembership' | 'UpdateSipMediaApplication' | 'UpdateSipRule' | 'UpdateSupportedLicenses' | 'UpdateUser' | 'UpdateUserLicenses' | 'UpdateUserSettings' | 'UpdateVoiceConnector' | 'UpdateVoiceConnectorGroup';
export type ChimeActionsRead = 'GetAccount' | 'GetAccountResource' | 'GetAccountSettings' | 'GetAccountWithOpenIdConfig' | 'GetAttendee' | 'GetBot' | 'GetCDRBucket' | 'GetDomain' | 'GetEventsConfiguration' | 'GetGlobalSettings' | 'GetMeeting' | 'GetMeetingDetail' | 'GetPhoneNumber' | 'GetPhoneNumberOrder' | 'GetPhoneNumberSettings' | 'GetProxySession' | 'GetRetentionSettings' | 'GetRoom' | 'GetSipMediaApplication' | 'GetSipMediaApplicationLoggingConfiguration' | 'GetSipRule' | 'GetTelephonyLimits' | 'GetUser' | 'GetUserActivityReportData' | 'GetUserByEmail' | 'GetUserSettings' | 'GetVoiceConnector' | 'GetVoiceConnectorEmergencyCallingConfiguration' | 'GetVoiceConnectorGroup' | 'GetVoiceConnectorLoggingConfiguration' | 'GetVoiceConnectorOrigination' | 'GetVoiceConnectorProxy' | 'GetVoiceConnectorStreamingConfiguration' | 'GetVoiceConnectorTermination' | 'GetVoiceConnectorTerminationHealth' | 'SearchAvailablePhoneNumbers' | 'ValidateAccountResource';
export type ChimeActionsList = 'ListAccountUsageReportData' | 'ListAccounts' | 'ListApiKeys' | 'ListAttendeeTags' | 'ListAttendees' | 'ListBots' | 'ListCDRBucket' | 'ListCallingRegions' | 'ListDelegates' | 'ListDirectories' | 'ListDomains' | 'ListGroups' | 'ListMeetingEvents' | 'ListMeetingTags' | 'ListMeetings' | 'ListMeetingsReportData' | 'ListPhoneNumberOrders' | 'ListPhoneNumbers' | 'ListProxySessions' | 'ListRoomMemberships' | 'ListRooms' | 'ListSipMediaApplications' | 'ListSipRules' | 'ListTagsForResource' | 'ListUsers' | 'ListVoiceConnectorGroups' | 'ListVoiceConnectorTerminationCredentials' | 'ListVoiceConnectors' | 'RetrieveDataExports';
export type ChimeActionsTagging = 'TagAttendee' | 'TagMeeting' | 'TagResource' | 'UntagAttendee' | 'UntagMeeting' | 'UntagResource';
export type ChimeActions = ChimeActionsWrite | ChimeActionsRead | ChimeActionsList | ChimeActionsTagging;
