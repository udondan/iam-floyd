...
export type ServicecatalogActionsWrite = 'AcceptPortfolioShare' | 'AssociateAttributeGroup' | 'AssociateBudgetWithResource' | 'AssociatePrincipalWithPortfolio' | 'AssociateProductWithPortfolio' | 'AssociateResource' | 'AssociateServiceActionWithProvisioningArtifact' | 'AssociateTagOptionWithResource' | 'BatchAssociateServiceActionWithProvisioningArtifact' | 'BatchDisassociateServiceActionFromProvisioningArtifact' | 'CopyProduct' | 'CreateApplication' | 'CreateAttributeGroup' | 'CreateConstraint' | 'CreatePortfolio' | 'CreateProduct' | 'CreateProvisionedProductPlan' | 'CreateProvisioningArtifact' | 'CreateServiceAction' | 'CreateTagOption' | 'DeleteApplication' | 'DeleteAttributeGroup' | 'DeleteConstraint' | 'DeletePortfolio' | 'DeleteProduct' | 'DeleteProvisionedProductPlan' | 'DeleteProvisioningArtifact' | 'DeleteServiceAction' | 'DeleteTagOption' | 'DisableAWSOrganizationsAccess' | 'DisassociateAttributeGroup' | 'DisassociateBudgetFromResource' | 'DisassociatePrincipalFromPortfolio' | 'DisassociateProductFromPortfolio' | 'DisassociateResource' | 'DisassociateServiceActionFromProvisioningArtifact' | 'DisassociateTagOptionFromResource' | 'EnableAWSOrganizationsAccess' | 'ExecuteProvisionedProductPlan' | 'ExecuteProvisionedProductServiceAction' | 'ImportAsProvisionedProduct' | 'ProvisionProduct' | 'RejectPortfolioShare' | 'TerminateProvisionedProduct' | 'UpdateApplication' | 'UpdateAttributeGroup' | 'UpdateConstraint' | 'UpdatePortfolio' | 'UpdateProduct' | 'UpdateProvisionedProduct' | 'UpdateProvisionedProductProperties' | 'UpdateProvisioningArtifact' | 'UpdateServiceAction' | 'UpdateTagOption';
export type ServicecatalogActionsPermissions management = 'CreatePortfolioShare' | 'DeletePortfolioShare';

export type ServicecatalogActionsRead = 'DescribeConstraint' | 'DescribeCopyProductStatus' | 'DescribePortfolio' | 'DescribePortfolioShareStatus' | 'DescribeProduct' | 'DescribeProductAsAdmin' | 'DescribeProductView' | 'DescribeProvisionedProduct' | 'DescribeProvisionedProductPlan' | 'DescribeProvisioningArtifact' | 'DescribeProvisioningParameters' | 'DescribeRecord' | 'DescribeServiceAction' | 'DescribeServiceActionExecutionParameters' | 'DescribeTagOption' | 'GetAWSOrganizationsAccessStatus' | 'GetApplication' | 'GetAttributeGroup';
export type ServicecatalogActionsList = 'ListAcceptedPortfolioShares' | 'ListApplications' | 'ListAssociatedAttributeGroups' | 'ListAssociatedResources' | 'ListAttributeGroups' | 'ListBudgetsForResource' | 'ListConstraintsForPortfolio' | 'ListLaunchPaths' | 'ListOrganizationPortfolioAccess' | 'ListPortfolioAccess' | 'ListPortfolios' | 'ListPortfoliosForProduct' | 'ListPrincipalsForPortfolio' | 'ListProvisionedProductPlans' | 'ListProvisioningArtifacts' | 'ListProvisioningArtifactsForServiceAction' | 'ListRecordHistory' | 'ListResourcesForTagOption' | 'ListServiceActions' | 'ListServiceActionsForProvisioningArtifact' | 'ListStackInstancesForProvisionedProduct' | 'ListTagOptions' | 'ScanProvisionedProducts' | 'SearchProducts' | 'SearchProductsAsAdmin' | 'SearchProvisionedProducts';
export type ServicecatalogActions = ServicecatalogActionsWrite | ServicecatalogActionsPermissions management | ServicecatalogActionsRead | ServicecatalogActionsList;
