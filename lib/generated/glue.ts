...
export type GlueActionsWrite = 'BatchCreatePartition' | 'BatchDeleteConnection' | 'BatchDeletePartition' | 'BatchDeleteTable' | 'BatchDeleteTableVersion' | 'BatchStopJobRun' | 'CancelMLTaskRun' | 'CreateClassifier' | 'CreateConnection' | 'CreateCrawler' | 'CreateDatabase' | 'CreateDevEndpoint' | 'CreateJob' | 'CreateMLTransform' | 'CreatePartition' | 'CreateRegistry' | 'CreateSchema' | 'CreateScript' | 'CreateSecurityConfiguration' | 'CreateTable' | 'CreateTrigger' | 'CreateUserDefinedFunction' | 'CreateWorkflow' | 'DeleteClassifier' | 'DeleteConnection' | 'DeleteCrawler' | 'DeleteDatabase' | 'DeleteDevEndpoint' | 'DeleteJob' | 'DeleteMLTransform' | 'DeletePartition' | 'DeleteRegistry' | 'DeleteResourcePolicy' | 'DeleteSchema' | 'DeleteSchemaVersions' | 'DeleteSecurityConfiguration' | 'DeleteTable' | 'DeleteTableVersion' | 'DeleteTrigger' | 'DeleteUserDefinedFunction' | 'DeleteWorkflow' | 'GetMapping' | 'ImportCatalogToGlue' | 'PutDataCatalogEncryptionSettings' | 'PutResourcePolicy' | 'PutSchemaVersionMetadata' | 'PutWorkflowRunProperties' | 'RegisterSchemaVersion' | 'RemoveSchemaVersionMetadata' | 'ResetJobBookmark' | 'StartCrawler' | 'StartCrawlerSchedule' | 'StartExportLabelsTaskRun' | 'StartImportLabelsTaskRun' | 'StartJobRun' | 'StartMLEvaluationTaskRun' | 'StartMLLabelingSetGenerationTaskRun' | 'StartTrigger' | 'StartWorkflowRun' | 'StopCrawler' | 'StopCrawlerSchedule' | 'StopTrigger' | 'UpdateClassifier' | 'UpdateConnection' | 'UpdateCrawler' | 'UpdateCrawlerSchedule' | 'UpdateDatabase' | 'UpdateDevEndpoint' | 'UpdateJob' | 'UpdateMLTransform' | 'UpdatePartition' | 'UpdateRegistry' | 'UpdateSchema' | 'UpdateTable' | 'UpdateTrigger' | 'UpdateUserDefinedFunction' | 'UpdateWorkflow' | 'UseMLTransforms';
export type GlueActionsRead = 'BatchGetCrawlers' | 'BatchGetDevEndpoints' | 'BatchGetJobs' | 'BatchGetPartition' | 'BatchGetTriggers' | 'BatchGetWorkflows' | 'CheckSchemaVersionValidity' | 'GetCatalogImportStatus' | 'GetClassifier' | 'GetClassifiers' | 'GetConnection' | 'GetConnections' | 'GetCrawler' | 'GetCrawlerMetrics' | 'GetCrawlers' | 'GetDataCatalogEncryptionSettings' | 'GetDatabase' | 'GetDatabases' | 'GetDataflowGraph' | 'GetDevEndpoint' | 'GetDevEndpoints' | 'GetJob' | 'GetJobBookmark' | 'GetJobRun' | 'GetJobRuns' | 'GetJobs' | 'GetMLTaskRun' | 'GetMLTransform' | 'GetPartition' | 'GetPartitions' | 'GetPlan' | 'GetRegistry' | 'GetResourcePolicy' | 'GetSchema' | 'GetSchemaByDefinition' | 'GetSchemaVersion' | 'GetSchemaVersionsDiff' | 'GetSecurityConfiguration' | 'GetSecurityConfigurations' | 'GetTable' | 'GetTableVersion' | 'GetTableVersions' | 'GetTables' | 'GetTags' | 'GetTrigger' | 'GetTriggers' | 'GetUserDefinedFunction' | 'GetUserDefinedFunctions' | 'GetWorkflow' | 'GetWorkflowRun' | 'GetWorkflowRunProperties' | 'GetWorkflowRuns' | 'SearchTables';
export type GlueActionsList = 'GetMLTaskRuns' | 'GetMLTransforms' | 'ListCrawlers' | 'ListDevEndpoints' | 'ListJobs' | 'ListMLTransforms' | 'ListRegistries' | 'ListSchemaVersions' | 'ListSchemas' | 'ListTriggers' | 'ListWorkflows' | 'QuerySchemaVersionMetadata';
export type GlueActionsTagging = 'TagResource' | 'UntagResource';
export type GlueActions = GlueActionsWrite | GlueActionsRead | GlueActionsList | GlueActionsTagging;
