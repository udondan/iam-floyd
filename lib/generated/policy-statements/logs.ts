...
/**
 * Statement provider for service [logs](https://docs.aws.amazon.com/service-authorization/latest/reference/list_logs.html).
 *
...
export class Logs extends PolicyStatement {
   ...
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/cwl_intelligent_tier.html
   */
  public toGetStorageTierPolicy() {
    return this.to('GetStorageTierPolicy');
  }
   ...
   * https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/cwl_intelligent_tier.html
   */
  public toPutStorageTierPolicy() {
    return this.to('PutStorageTierPolicy');
  }
   ...
   * - .toGetQueryResults()
   * - .toGetScheduledQuery()
   * - .toGetScheduledQueryHistory()
   * - .toGetTransformer()
   * - .toListAnomalies()
   * - .toListLogAnomalyDetectors()
   * - .toListTagsForResource()
   * - .toListTagsLogGroup()
   * - .toPutBearerTokenAuthentication()
   ...
   * - .toPutLogEvents()
   * - .toPutLogGroupDeletionProtection()
   * - .toPutMetricFilter()
   * - .toPutRetentionPolicy()
   * - .toPutSubscriptionFilter()
   * - .toPutSyslogConfiguration()
   * - .toPutTransformer()
   * - .toStartLiveTail()
   * - .toStartQuery()
   * - .toTagLogGroup()
