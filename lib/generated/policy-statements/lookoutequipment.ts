...
/**
 * Statement provider for service [lookoutequipment](https://docs.aws.amazon.com/service-authorization/latest/reference/list_lookoutequipment.html).
 *
...
export class Lookoutequipment extends PolicyStatement {
   ...
   * - .toDeleteRetrainingScheduler()
   * - .toDescribeDataset()
   * - .toDescribeInferenceScheduler()
   * - .toDescribeLabelGroup()
   * - .toDescribeModel()
   * - .toDescribeModelVersion()
   * - .toDescribeResourcePolicy()
   * - .toDescribeRetrainingScheduler()
   * - .toDescribelabel()
   * - .toImportDataset()
   * - .toImportModelVersion()
   * - .toListDataIngestionJobs()
   * - .toListInferenceEvents()
   * - .toListInferenceExecutions()
   * - .toListLabelGroups()
   * - .toListLabels()
   * - .toListModelVersions()
   * - .toListSensorStatistics()
   * - .toListTagsForResource()
   * - .toPutResourcePolicy()
   * - .toStartDataIngestionJob()
   * - .toStartInferenceScheduler()
   * - .toStartRetrainingScheduler()
   * - .toStopInferenceScheduler()
   * - .toStopRetrainingScheduler()
   * - .toTagResource()
   * - .toUntagResource()
   * - .toUpdateActiveModelVersion()
   * - .toUpdateInferenceScheduler()
   * - .toUpdateLabelGroup()
   * - .toUpdateModel()
   * - .toUpdateRetrainingScheduler()
   *
