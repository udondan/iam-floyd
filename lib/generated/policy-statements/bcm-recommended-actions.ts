...
/**
 * Statement provider for service [bcm-recommended-actions](https://docs.aws.amazon.com/service-authorization/latest/reference/list_bcm-recommended-actions.html).
 *
