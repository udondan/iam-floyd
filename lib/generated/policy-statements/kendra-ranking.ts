...
/**
 * Statement provider for service [kendra-ranking](https://docs.aws.amazon.com/service-authorization/latest/reference/list_kendra-ranking.html).
 *
...
export class KendraRanking extends PolicyStatement {
   ...
   *
   * Applies to actions:
   * - .toDeleteRescoreExecutionPlan()
   * - .toDescribeRescoreExecutionPlan()
   * - .toListTagsForResource()
   * - .toRescore()
   * - .toTagResource()
   * - .toUntagResource()
   * - .toUpdateRescoreExecutionPlan()
   *
