...
/**
 * Statement provider for service [ssm-sap](https://docs.aws.amazon.com/service-authorization/latest/reference/list_ssm-sap.html).
 *
...
export class SsmSap extends PolicyStatement {
   ...
   *
   * Applies to actions:
   * - .toDeregisterApplication()
   * - .toGetComponent()
   * - .toListComponents()
   * - .toStartApplication()
   * - .toStartApplicationRefresh()
   * - .toStopApplication()
   * - .toTagResource()
   * - .toUntagResource()
