...
/**
 * Statement provider for service [fms](https://docs.aws.amazon.com/service-authorization/latest/reference/list_fms.html).
 *
...
export class Fms extends PolicyStatement {
   ...
   *
   * Applies to actions:
   * - .toBatchAssociateResource()
   * - .toBatchDisassociateResource()
   * - .toDeleteAppsList()
   * - .toDeletePolicy()
   ...
   * - .toGetProtocolsList()
   * - .toGetResourceSet()
   * - .toGetViolationDetails()
   * - .toListComplianceStatus()
   * - .toListResourceSetResources()
