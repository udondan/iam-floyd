...
/**
 * Statement provider for service [es](https://docs.aws.amazon.com/service-authorization/latest/reference/list_es.html).
 *
...
export class Es extends PolicyStatement {
  ...
  /**
   * Grants permission to get the status and progress of a migration job for an OpenSearch Application
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/opensearch-service/latest/APIReference/API_GetMigration.html
   */
  ...
  /**
   * Grants permission to list migration jobs for an OpenSearch Application
   *
   * Access Level: List
   *
   * https://docs.aws.amazon.com/opensearch-service/latest/APIReference/API_ListMigrations.html
   */
  public toListMigrations() {
    return this.to('ListMigrations');
  }
  ...
  /**
   * Grants permission to initiate a migration of saved objects to an OpenSearch Application
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/opensearch-service/latest/APIReference/API_StartMigration.html
   */
   ...
   * - .toDeleteIndex()
   * - .toDeregisterCapability()
   * - .toDescribeDataSourceAttachment()
   * - .toDescribeDomain()
   ...
   * - .toGetDataSource()
   * - .toGetDefaultApplicationSetting()
   ...
   * - .toListTags()
   * - .toPutDefaultApplicationSetting()
   * - .toRegisterCapability()
   * - .toRemoveTags()
   * - .toRollbackElasticsearchServiceSoftwareUpdate()
   * - .toRollbackServiceSoftwareUpdate()
