...
/**
 * Statement provider for service [aws-marketplace-catalog](https://docs.aws.amazon.com/service-authorization/latest/reference/list_marketplace-catalog.html).
 *
...
export class AwsMarketplaceCatalog extends PolicyStatement {
  ...
  /**
   * Grants permission to retrieve details of a tax compliance profile including artifacts with download URLs
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/compliance-api-access-control.html
   */
  public toGetTaxComplianceProfile() {
    return this.to('GetTaxComplianceProfile');
  }
  ...
  /**
   * Grants permission to list tags on an existing entity, change set, invoice submission task, issued tax invoice, VerificationEvidence, TaxComplianceProfile, or TaxComplianceProfileChangeTask
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list tax compliance profile change tasks with optional filters
   *
   * Access Level: List
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/compliance-api-access-control.html
   */
  public toListTaxComplianceProfileChangeTasks() {
    return this.to('ListTaxComplianceProfileChangeTasks');
  }

  /**
   * Grants permission to list tax compliance profiles with optional filters
   *
   * Access Level: List
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/compliance-api-access-control.html
   */
  public toListTaxComplianceProfiles() {
    return this.to('ListTaxComplianceProfiles');
  }
  ...
  /**
   * Grants permission to initiate asynchronous processing of a tax compliance profile create or update with artifact validation
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/compliance-api-access-control.html
   */
  public toStartTaxComplianceProfileChangeTask() {
    return this.to('StartTaxComplianceProfileChangeTask');
  }
  ...
  /**
   * Grants permission to add new tags to a resource. Supported resources: Entity, ChangeSet, InvoiceSubmissionTask, IssuedTaxInvoice, VerificationEvidence, TaxComplianceProfile, and TaxComplianceProfileChangeTask
   *
  ...
  /**
   * Grants permission to remove tags from a resource. Supported resources: Entity, ChangeSet, InvoiceSubmissionTask, IssuedTaxInvoice, VerificationEvidence, TaxComplianceProfile, and TaxComplianceProfileChangeTask
   *
   * Access Level: Tagging, Write
   *
  ...
  /**
   * Adds a resource of type TaxComplianceProfile to the statement
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/compliance-api-access-control.html
   *
   * @param resourceId - Identifier for the resourceId.
   ...
   * - .ifAwsResourceTag()
   */
  public onTaxComplianceProfile(resourceId: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:aws-marketplace:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:tax-compliance-profile/${ resourceId }`);
  }

  /**
   * Adds a resource of type TaxComplianceProfileChangeTask to the statement
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/compliance-api-access-control.html
   *
   * @param resourceId - Identifier for the resourceId.
   ...
   * - .ifAwsResourceTag()
   */
  public onTaxComplianceProfileChangeTask(resourceId: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:aws-marketplace:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:tax-compliance-profile-change-task/${ resourceId }`);
  }
   ...
   * - .toStartTaxComplianceProfileChangeTask()
   * - .toTagResource()
   *
   ...
   * - .toDescribeChangeSet()
   * - .toDescribeEntity()
   * - .toGetInvoiceSubmissionTask()
   * - .toGetIssuedTaxInvoice()
   * - .toGetResourcePolicy()
   * - .toGetTaxComplianceProfile()
   * - .toGetVerificationEvidence()
