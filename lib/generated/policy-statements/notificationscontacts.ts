...
/**
 * Statement provider for service [notifications-contacts](https://docs.aws.amazon.com/service-authorization/latest/reference/list_notificationscontacts.html).
 *
...
export class NotificationsContacts extends PolicyStatement {
   ...
   *
   * Applies to actions:
   * - .toActivateEmailContact()
   * - .toCreateEmailContact()
   * - .toDeleteEmailContact()
   * - .toGetEmailContact()
