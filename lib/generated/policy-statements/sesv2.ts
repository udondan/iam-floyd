...
/**
 * Statement provider for service [ses-v2](https://docs.aws.amazon.com/service-authorization/latest/reference/list_sesv2.html).
 *
...
export class SesV2 extends PolicyStatement {
  ...
  /**
   * Grants permission to set the pricing plan for your account
   *
   * Access Level: Write
   *
   * Possible conditions:
   * - .ifApiVersion()
   *
   * https://docs.aws.amazon.com/ses/latest/APIReference-V2/API_PutAccountPricingAttributes.html
   */
  public toPutAccountPricingAttributes() {
    return this.to('PutAccountPricingAttributes');
  }
