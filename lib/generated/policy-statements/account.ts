...
/**
 * Statement provider for service [account](https://docs.aws.amazon.com/service-authorization/latest/reference/list_account.html).
 *
...
export class Account extends PolicyStatement {
  ...
  /**
   * Grants permission to retrieve information about the most recent primary email update for the account
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/accounts/latest/reference/API_GetPrimaryEmailUpdateStatus.html
   */
  public toGetPrimaryEmailUpdateStatus() {
    return this.to('GetPrimaryEmailUpdateStatus');
  }
