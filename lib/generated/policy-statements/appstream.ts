...
/**
 * Statement provider for service [appstream](https://docs.aws.amazon.com/service-authorization/latest/reference/list_appstream.html).
 *
...
export class Appstream extends PolicyStatement {
   ...
   * - .toDescribeSessions()
   * - .toDescribeSoftwareAssociations()
