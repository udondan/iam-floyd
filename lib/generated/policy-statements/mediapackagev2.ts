...
/**
 * Statement provider for service [mediapackagev2](https://docs.aws.amazon.com/service-authorization/latest/reference/list_mediapackagev2.html).
 *
...
export class Mediapackagev2 extends PolicyStatement {
   ...
   * - .toCreateOriginEndpoint()
   * - .toDeleteChannel()
   * - .toDeleteChannelGroup()
   * - .toDeleteChannelPolicy()
   * - .toDeleteOriginEndpoint()
   * - .toDeleteOriginEndpointPolicy()
   * - .toGetChannel()
   * - .toGetChannelGroup()
   * - .toGetChannelPolicy()
   * - .toGetHarvestJob()
   ...
   * - .toPutChannelPolicy()
   * - .toPutObject()
   * - .toPutOriginEndpointPolicy()
   * - .toResetChannelState()
   * - .toResetOriginEndpointState()
   * - .toTagResource()
   * - .toUntagResource()
   * - .toUpdateChannel()
   * - .toUpdateChannelGroup()
