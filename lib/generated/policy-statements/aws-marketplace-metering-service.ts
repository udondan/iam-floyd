...
/**
 * Statement provider for service [aws-marketplace-metering-service](https://docs.aws.amazon.com/service-authorization/latest/reference/list_meteringmarketplace.html).
 *
...
export class AwsMarketplaceMeteringService extends PolicyStatement {
   ...
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/API_marketplace-metering_MeterUsage.html
   */
  public toMeterUsage() {
   ...
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/marketplace/latest/APIReference/API_marketplace-metering_RegisterUsage.html
   */
