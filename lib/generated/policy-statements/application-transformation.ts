...
/**
 * Statement provider for service [application-transformation](https://docs.aws.amazon.com/service-authorization/latest/reference/list_application-transformation.html).
 *
