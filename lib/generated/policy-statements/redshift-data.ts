...
/**
 * Statement provider for service [redshift-data](https://docs.aws.amazon.com/service-authorization/latest/reference/list_redshift-data.html).
 *
...
export class RedshiftData extends PolicyStatement {
  ...
  /**
   * Grants permission to list sessions for a given principal
   *
   * Access Level: List
   *
   * Possible conditions:
