...
/**
 * Statement provider for service [arc-region-switch](https://docs.aws.amazon.com/service-authorization/latest/reference/list_arc-region-switch.html).
 *
...
export class ArcRegionSwitch extends PolicyStatement {
   ...
   * - .toListRoute53HealthChecksInRegion()
