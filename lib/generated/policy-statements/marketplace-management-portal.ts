...
/**
 * Statement provider for service [marketplace-management-portal](https://docs.aws.amazon.com/service-authorization/latest/reference/list_aws-marketplace-management.html).
 *
 * @param sid [SID](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_sid.html) of the statement
 */
export class MarketplaceManagementPortal extends PolicyStatement {
