...
export class SmsVoiceV2 extends PolicyStatement {
   ...
   */
  public toCreateNotifyConfiguration() {
   ...
   */
  public toDeleteNotifyConfiguration() {
   ...
   */
  public toDeleteNotifyMessageSpendLimitOverride() {
   ...
   */
  public toDeleteProtectConfigurationRuleSetNumberOverride() {
   ...
   */
  public toDeleteRcsMessageSpendLimitOverride() {
   ...
   */
  public toDescribeNotifyConfigurations() {
   ...
   */
  public toDescribeNotifyTemplates() {
   ...
   */
  public toDescribeRcsAgentCountryLaunchStatus() {
   ...
   */
  public toListProtectConfigurationRuleSetNumberOverrides() {
   ...
   */
  public toPutProtectConfigurationRuleSetNumberOverride() {
   ...
   */
  public toSendNotifyTextMessage() {
   ...
   */
  public toSendNotifyVoiceMessage() {
   ...
   */
  public toSetDefaultMessageFeedbackEnabled() {
   ...
   */
  public toSetNotifyMessageSpendLimitOverride() {
   ...
   */
  public toSetRcsMessageSpendLimitOverride() {
   ...
   */
  public toUpdateNotifyConfiguration() {
   ...
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`, unless using the CDK, where the default is the current Stack's partition.
   */
  public onMessage(messageId: string, account?: string, region?: string, partition?: string) {
   ...
   * - .ifAwsResourceTag()
   */
  public onNotifyConfiguration(notifyConfigurationId: string, account?: string, region?: string, partition?: string) {
   ...
   * - .ifAwsResourceTag()
   */
  public onRcsAgent(rcsAgentId: string, account?: string, region?: string, partition?: string) {
