...
/**
 * Statement provider for service [osis](https://docs.aws.amazon.com/service-authorization/latest/reference/list_osis.html).
 *
...
export class Osis extends PolicyStatement {
   ...
   * - .toCreatePipelineEndpoint()
   * - .toDeletePipeline()
   * - .toDeletePipelineEndpoint()
   * - .toDeleteResourcePolicy()
   * - .toGetPipeline()
   * - .toGetPipelineChangeProgress()
   * - .toGetResourcePolicy()
   * - .toIngest()
   * - .toListTagsForResource()
   * - .toPutResourcePolicy()
   * - .toRevokePipelineEndpointConnections()
   * - .toStartPipeline()
   * - .toStopPipeline()
   * - .toTagResource()
   * - .toUntagResource()
