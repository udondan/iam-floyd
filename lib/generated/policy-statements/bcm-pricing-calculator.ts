...
/**
 * Statement provider for service [bcm-pricing-calculator](https://docs.aws.amazon.com/service-authorization/latest/reference/list_bcm-pricing-calculator.html).
 *
