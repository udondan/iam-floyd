...
/**
 * Statement provider for service [apptest](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsmainframemodernizationapplicationtestingprovidestoolsandresourcesforautomatedfunctionalequivalencetestingforyourmigrationprojects..html).
 *
...
export class Apptest extends PolicyStatement {
   ...
   *
   * https://docs.aws.amazon.com/apptest/latest/APIReference/concept-apptest.html#TestCase-concept
   *
   ...
   *
   * https://docs.aws.amazon.com/apptest/latest/APIReference/concept-apptest.html#TestConfiguration-concept
   *
   ...
   *
   * https://docs.aws.amazon.com/apptest/latest/APIReference/concept-apptest.html#TestRun-concept
   *
   ...
   *
   * https://docs.aws.amazon.com/apptest/latest/APIReference/concept-apptest.html#TestSuite-concept
   *
