...
/**
 * Statement provider for service [elemental-support-cases](https://docs.aws.amazon.com/service-authorization/latest/reference/list_elemental-support-cases.html).
 *
...
export class ElementalSupportCases extends PolicyStatement {
   ...
   * - .toCreateS3CLIUploadCommand()
   * - .toCreateS3DownloadUrl()
   * - .toGetCase()
   * - .toListTagsForCase()
   * - .toStartMultipartUpload()
   * - .toTagCase()
   * - .toUntagCase()
   * - .toUpdateCase()
   * - .toUpdateCaseStatus()
   * - .toUpdateMultipartUpload()
   *
