...
/**
 * Statement provider for service [aws-marketplace-deployment-service](https://docs.aws.amazon.com/service-authorization/latest/reference/list_marketplace-deployment.html).
 *
