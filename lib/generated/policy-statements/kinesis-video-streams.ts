...
/**
 * Statement provider for service [kinesisvideo](https://docs.aws.amazon.com/service-authorization/latest/reference/list_kinesis-video-streams.html).
 *
...
export class Kinesisvideo extends PolicyStatement {
   ...
   * - .toDescribeStream()
   * - .toDescribeStreamStorageConfiguration()
   * - .toGetClip()
   ...
   * - .toUpdateStream()
   * - .toUpdateStreamStorageConfiguration()
   *
