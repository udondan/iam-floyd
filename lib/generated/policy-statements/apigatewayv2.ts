...
/**
 * Statement provider for service [apigateway-v2](https://docs.aws.amazon.com/service-authorization/latest/reference/list_apigatewayv2.html).
 *
...
export class ApigatewayV2 extends PolicyStatement {
   ...
   * @param authorizerId2 - Identifier for the authorizerId2.
   * @param region - Region of the resource; defaults to `*`, unless using the CDK, where the default is the current Stack's region.
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`, unless using the CDK, where the default is the current Stack's partition.
   *
   * Possible conditions:
   ...
   * - .ifAwsResourceTag()
   */
  public onAuthorizer(apiId: string, authorizerId: string, partition2: string, region2: string, restApiId: string, authorizerId2: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/authorizers/${ authorizerId }, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/authorizers/${ authorizerId2 }`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onAuthorizers(apiId: string, partition2: string, region2: string, restApiId: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/authorizers, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/authorizers`);
  }
   ...
   * @param region2 - Identifier for the region2.
   * @param restApiId - Identifier for the restApiId.
   * @param deploymentId2 - Identifier for the deploymentId2.
   * @param region - Region of the resource; defaults to `*`, unless using the CDK, where the default is the current Stack's region.
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`, unless using the CDK, where the default is the current Stack's partition.
   *
   * Possible conditions:
   * - .ifAwsResourceTag()
   */
  public onDeployment(apiId: string, deploymentId: string, partition2: string, region2: string, restApiId: string, deploymentId2: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/deployments/${ deploymentId }, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/deployments/${ deploymentId2 }`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onDeployments(apiId: string, partition2: string, region2: string, restApiId: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/deployments, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/deployments`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onIntegration(apiId: string, integrationId: string, partition2: string, region2: string, restApiId: string, resourceId: string, httpMethodType: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/integrations/${ integrationId }, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/resources/${ resourceId }/methods/${ httpMethodType }/integration`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onIntegrationResponse(apiId: string, integrationId: string, integrationResponseId: string, partition2: string, region2: string, restApiId: string, resourceId: string, httpMethodType: string, statusCode: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/integrations/${ integrationId }/integrationresponses/${ integrationResponseId }, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/resources/${ resourceId }/methods/${ httpMethodType }/integration/responses/${ statusCode }`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onModel(apiId: string, modelId: string, partition2: string, region2: string, restApiId: string, modelName: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/models/${ modelId }, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/models/${ modelName }`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onModels(apiId: string, partition2: string, region2: string, restApiId: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/models, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/models`);
  }
   ...
   * @param region2 - Identifier for the region2.
   * @param restApiId - Identifier for the restApiId.
   * @param stageName2 - Identifier for the stageName2.
   * @param region - Region of the resource; defaults to `*`, unless using the CDK, where the default is the current Stack's region.
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`, unless using the CDK, where the default is the current Stack's partition.
   *
   * Possible conditions:
   ...
   * - .ifAwsResourceTag()
   */
  public onStage(apiId: string, stageName: string, partition2: string, region2: string, restApiId: string, stageName2: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/stages/${ stageName }, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/stages/${ stageName2 }`);
  }
   ...
   * - .ifAwsResourceTag()
   */
  public onStages(apiId: string, partition2: string, region2: string, restApiId: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:apigateway:${ region ?? this.defaultRegion }::/apis/${ apiId }/stages, arn:${ partition2 }:apigateway:${ region2 }::/restapis/${ restApiId }/stages`);
  }
