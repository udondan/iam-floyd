...
/**
 * Statement provider for service [gamelift](https://docs.aws.amazon.com/service-authorization/latest/reference/list_gamelift.html).
 *
...
export class Gamelift extends PolicyStatement {
   ...
   * - .ifAwsResourceTag()
   */
  public onContainerFleet(fleetId: string, account?: string, region?: string, partition?: string) {
   ...
   * - .toDescribeContainerGroupPortMappings()
