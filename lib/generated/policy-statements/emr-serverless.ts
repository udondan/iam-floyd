...
/**
 * Statement provider for service [emr-serverless](https://docs.aws.amazon.com/service-authorization/latest/reference/list_emr-serverless.html).
 *
...
export class EmrServerless extends PolicyStatement {
   ...
   * - .toDeleteApplication()
   * - .toGetApplication()
   * - .toGetDashboardForJobRun()
   * - .toGetJobRun()
   * - .toGetResourceDashboard()
   * - .toGetSession()
   * - .toGetSessionEndpoint()
   * - .toListJobRunAttempts()
   * - .toListJobRuns()
   * - .toListSessions()
