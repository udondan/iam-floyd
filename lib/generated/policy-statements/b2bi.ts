...
/**
 * Statement provider for service [b2bi](https://docs.aws.amazon.com/service-authorization/latest/reference/list_b2bi.html).
 *
...
export class B2bi extends PolicyStatement {
   ...
   * - .toCreateCapability()
   * - .toCreatePartnership()
   * - .toCreateStarterMappingTemplate()
   * - .toDeleteCapability()
   * - .toDeletePartnership()
   * - .toDeleteProfile()
   * - .toDeleteTransformer()
