...
/**
 * Statement provider for service [mediaconnect](https://docs.aws.amazon.com/service-authorization/latest/reference/list_mediaconnect.html).
 *
...
export class Mediaconnect extends PolicyStatement {
   ...
   * - .toDeleteFlow()
   * - .toDeleteRouterInput()
   * - .toDeleteRouterNetworkInterface()
   * - .toDeleteRouterOutput()
   * - .toDescribeFlow()
   * - .toDescribeFlowSourceMetadata()
   * - .toDescribeFlowSourceThumbnail()
   * - .toGetRouterInput()
   * - .toGetRouterInputSourceMetadata()
   * - .toGetRouterInputThumbnail()
   * - .toGetRouterNetworkInterface()
   * - .toGetRouterOutput()
   * - .toGrantFlowEntitlements()
   ...
   * - .toRestartRouterInput()
   * - .toRestartRouterOutput()
   ...
   * - .toUpdateFlowSource()
   * - .toUpdateRouterInput()
   * - .toUpdateRouterNetworkInterface()
   * - .toUpdateRouterOutput()
   *
