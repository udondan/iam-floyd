...
export class Invoicing extends PolicyStatement {
   ...
   */
  public toListProcurementPortalSuppliers() {
    return this.to('ListProcurementPortalSuppliers');
  }
   ...
   */
  public toListProcurementPortals() {
    return this.to('ListProcurementPortals');
  }
   ...
   */
  public toSendProcurementPortalValidation() {
    return this.to('SendProcurementPortalValidation');
  }
   ...
   */
  public toVerifyProcurementPortalValidation() {
