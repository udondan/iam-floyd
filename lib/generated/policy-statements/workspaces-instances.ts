...
/**
 * Statement provider for service [workspaces-instances](https://docs.aws.amazon.com/service-authorization/latest/reference/list_workspaces-instances.html).
 *
...
export class WorkspacesInstances extends PolicyStatement {
   ...
   * - .toAssociateVolume()
   * - .toDeleteVolume()
   * - .toDeleteWorkspaceInstance()
   * - .toDisassociateVolume()
   * - .toGetWorkspaceInstance()
