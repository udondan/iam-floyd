...
/**
 * Statement provider for service [ssm](https://docs.aws.amazon.com/service-authorization/latest/reference/list_ssm.html).
 *
...
export class Ssm extends PolicyStatement {
   ...
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`, unless using the CDK, where the default is the current Stack's partition.
   */
  public onOpsitemgroup(account?: string, region?: string, partition?: string) {
