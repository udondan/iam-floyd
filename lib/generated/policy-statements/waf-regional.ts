...
/**
 * Statement provider for service [waf-regional](https://docs.aws.amazon.com/service-authorization/latest/reference/list_waf-regional.html).
 *
...
export class WafRegional extends PolicyStatement {
  ...
  public onBytematchset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:bytematchset/${ id }`);
  }
  ...
  public onGeomatchset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:geomatchset/${ id }`);
  }
  ...
  public onIpset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:ipset/${ id }`);
  }
  ...
  public onRatebasedrule(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:ratebasedrule/${ id }`);
  }
  ...
  public onRegexmatchset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:regexmatch/${ id }`);
  }
  ...
  public onRegexpatternset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:regexpatternset/${ id }`);
  }
  ...
  public onRule(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:rule/${ id }`);
  }
  ...
  public onRulegroup(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:rulegroup/${ id }`);
  }
  ...
  public onSizeconstraintset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:sizeconstraintset/${ id }`);
  }
  ...
  public onSqlinjectionmatchset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:sqlinjectionset/${ id }`);
  }
  ...
  public onWebacl(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:webacl/${ id }`);
  }
  ...
  public onXssmatchset(id: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:waf-regional:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:xssmatchset/${ id }`);
  }
