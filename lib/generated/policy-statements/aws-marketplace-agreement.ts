...
/**
 * Statement provider for service [aws-marketplace-agreement](https://docs.aws.amazon.com/service-authorization/latest/reference/list_marketplace-agreement.html).
 *
 * @param sid [SID](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_sid.html) of the statement
 */
export class AwsMarketplaceAgreement extends PolicyStatement {
