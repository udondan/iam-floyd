...
/**
 * Statement provider for service [arc-zonal-shift](https://docs.aws.amazon.com/service-authorization/latest/reference/list_arc-zonal-shift.html).
 *
...
export class ArcZonalShift extends PolicyStatement {
   ...
   */
  public ifResourceIdentifier(value: string | string[], operator?: Operator | string) {
