...
/**
 * Statement provider for service [pricingplanmanager](https://docs.aws.amazon.com/service-authorization/latest/reference/list_pricing-plan-manager.html).
 *
...
export class Pricingplanmanager extends PolicyStatement {
  ...
  /**
   * Grants permission to approve paid subscription
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/PricingPlanManager/latest/UserGuide/security-pricing-plan.html
   */
  public toApprovePaidSubscription() {
    return this.to('ApprovePaidSubscription');
  }
  ...
  /**
   * Grants permission to cancel a scheduled change for a subscription
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/PricingPlanManager/latest/UserGuide/security-pricing-plan.html
