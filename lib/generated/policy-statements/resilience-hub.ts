...
/**
 * Statement provider for service [resiliencehub](https://docs.aws.amazon.com/service-authorization/latest/reference/list_resilience-hub.html).
 *
...
export class Resiliencehub extends PolicyStatement {
  ...
  /**
   * Grants permission to create a test instance
   *
   * Access Level: Write
   *
  ...
  /**
   * Grants permission to delete test sources from a test
   *
   * Access Level: Write
   *
  ...
  /**
   * Grants permission to retrieve a test run
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to retrieve a test template
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list resolved target resources for a test run
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list test run source snapshots
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list test runs for a target
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list test sources on a test
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list available test templates
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to list tests for a target
   *
   * Access Level: Read
   *
  ...
  /**
   * Grants permission to put test sources on a test
   *
   * Access Level: Write
   *
   ...
   * @param partition - Partition of the AWS account [aws, aws-cn, aws-us-gov]; defaults to `aws`, unless using the CDK, where the default is the current Stack's partition.
   */
  public onTestTemplate(testTemplateId: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:resiliencehub:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:test-template/${ testTemplateId }`);
  }
   ...
   * - .toListReports()
   * - .toListResolvedTestRunTargetResources()
