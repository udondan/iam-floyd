...
export class Wellarchitected extends PolicyStatement {
   ...
   */
  public toGetAgentRecommendation() {
   ...
   */
  public toGetAgentRecommendationGeneration() {
   ...
   */
  public toListAgentRecommendationGenerations() {
   ...
   */
  public toListAgentRecommendationItems() {
   ...
   */
  public toListAgentRecommendations() {
   ...
   */
  public toPutAgentRecommendationFeedback() {
   ...
   */
  public toStartAgentRecommendationGeneration() {
   ...
   */
  public toUpdateAgentRecommendationStatus() {
   ...
   * - .ifAwsResourceTag()
   */
  public onAgentProfile(profileName: string, account?: string, region?: string, partition?: string) {
   ...
   * - .ifAwsResourceTag()
   */
  public onAgentRecommendation(resourceId: string, account?: string, region?: string, partition?: string) {
