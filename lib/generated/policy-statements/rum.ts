...
/**
 * Statement provider for service [rum](https://docs.aws.amazon.com/service-authorization/latest/reference/list_rum.html).
 *
...
export class Rum extends PolicyStatement {
   ...
   *
   * Applies to actions:
   * - .toBatchCreateRumMetricDefinitions()
   * - .toBatchDeleteRumMetricDefinitions()
   * - .toBatchGetRumMetricDefinitions()
   * - .toCreateAppMonitor()
   * - .toDeleteAppMonitor()
   * - .toDeleteResourcePolicy()
   * - .toDeleteRumMetricsDestination()
   * - .toGetAppMonitor()
   * - .toGetAppMonitorData()
   * - .toGetResourcePolicy()
   * - .toListRumMetricsDestinations()
   * - .toPutResourcePolicy()
   * - .toPutRumEvents()
   * - .toPutRumMetricsDestination()
   * - .toTagResource()
   * - .toUntagResource()
   * - .toUpdateAppMonitor()
   * - .toUpdateRumMetricDefinition()
   *
