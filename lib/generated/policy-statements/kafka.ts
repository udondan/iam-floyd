...
/**
 * Statement provider for service [kafka](https://docs.aws.amazon.com/service-authorization/latest/reference/list_kafka.html).
 *
...
export class Kafka extends PolicyStatement {
  ...
  /**
   * Grants permission to create an MSK Data Channel for an MSK cluster
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/msk/1.0/apireference/clusters-clusterarn-channels.html#CreateChannel
   */
  ...
  /**
   * Grants permission to delete an MSK Data Channel
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/msk/1.0/apireference/clusters-clusterarn-channels-channelarn.html#DeleteChannel
   */
  ...
  /**
   * Grants permission to describe an MSK Data Channel
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/msk/1.0/apireference/clusters-clusterarn-channels-channelarn.html#DescribeChannel
   */
  ...
  /**
   * Grants permission to list all MSK Data Channels for a specified MSK cluster
   *
   * Access Level: List
   *
   * https://docs.aws.amazon.com/msk/1.0/apireference/clusters-clusterarn-channels.html#ListChannels
   */
  ...
  /**
   * Grants permission to update the configuration of an MSK Data Channel
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/msk/1.0/apireference/clusters-clusterarn-channels-channelarn.html#UpdateChannel
   */
   ...
   *
   * https://docs.aws.amazon.com/msk/latest/developerguide/msk-data-channel.html
   *
   ...
   * - .ifAwsResourceTag()
   */
  public onChannel(clusterName: string, clusterUuid: string, channelName: string, uuid: string, account?: string, region?: string, partition?: string) {
    return this.on(`arn:${ partition ?? this.defaultPartition }:kafka:${ region ?? this.defaultRegion }:${ account ?? this.defaultAccount }:channel/${ clusterName }/${ clusterUuid }/${ channelName }/${ uuid }`);
  }
