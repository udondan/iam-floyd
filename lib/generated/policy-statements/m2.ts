...
/**
 * Statement provider for service [m2](https://docs.aws.amazon.com/service-authorization/latest/reference/list_m2.html).
 *
...
export class M2 extends PolicyStatement {
   ...
   *
   * Applies to actions:
   * - .toCancelBatchJobExecution()
   * - .toCreateDataSetExportTask()
   * - .toCreateDataSetImportTask()
   * - .toCreateDeployment()
   * - .toDeleteApplication()
   * - .toDeleteApplicationFromEnvironment()
   * - .toDeleteEnvironment()
   * - .toGetApplication()
   * - .toGetApplicationVersion()
   * - .toGetBatchJobExecution()
   * - .toGetDataSetDetails()
   * - .toGetDataSetExportTask()
   * - .toGetDataSetImportTask()
   * - .toGetDeployment()
   * - .toGetEnvironment()
   * - .toListApplicationVersions()
   * - .toListBatchJobDefinitions()
   * - .toListBatchJobExecutions()
   * - .toListBatchJobRestartPoints()
   * - .toListDataSetExportHistory()
   * - .toListDataSetImportHistory()
   * - .toListDataSets()
   * - .toListDeployments()
   * - .toStartApplication()
   * - .toStartBatchJob()
