...
/**
 * Statement provider for service [cognito-idp](https://docs.aws.amazon.com/service-authorization/latest/reference/list_cognito-idp.html).
 *
...
export class CognitoIdp extends PolicyStatement {
  ...
  /**
   * Grants permission to look up any user's configured auth factors
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_AdminGetUserAuthFactors.html
   */
  public toAdminGetUserAuthFactors() {
    return this.to('AdminGetUserAuthFactors');
  }
  ...
  /**
   * Grants permission to get a provisioned limit for the AWS account
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_GetProvisionedLimit.html
   */
  public toGetProvisionedLimit() {
    return this.to('GetProvisionedLimit');
  }
  ...
  /**
   * Grants permission to update a provisioned limit for the AWS account
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_UpdateProvisionedLimit.html
   */
  public toUpdateProvisionedLimit() {
    return this.to('UpdateProvisionedLimit');
  }
   ...
   * - .toDeleteUserPoolClientSecret()
   * - .toDeleteUserPoolDomain()
   * - .toDeleteUserPoolReplica()
   ...
   * - .toListUserPoolClientSecrets()
   * - .toListUserPoolClients()
   * - .toListUserPoolReplicas()
   * - .toListUsers()
   * - .toListUsersInGroup()
