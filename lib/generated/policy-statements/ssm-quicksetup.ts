...
/**
 * Statement provider for service [ssm-quicksetup](https://docs.aws.amazon.com/service-authorization/latest/reference/list_ssm-quicksetup.html).
 *
...
export class SsmQuicksetup extends PolicyStatement {
   ...
   * Applies to actions:
   * - .toCreateConfigurationManager()
   * - .toDeleteConfigurationManager()
   * - .toGetConfiguration()
   * - .toGetConfigurationManager()
   * - .toListConfigurations()
   * - .toListTagsForResource()
   * - .toTagResource()
   * - .toUntagResource()
   * - .toUpdateConfigurationDefinition()
   * - .toUpdateConfigurationManager()
   *
