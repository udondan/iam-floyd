...
/**
 * Statement provider for service [opsworks-cm](https://docs.aws.amazon.com/service-authorization/latest/reference/list_opsworks-cm.html).
 *
...
export class OpsworksCm extends PolicyStatement {
   ...
   *
   * https://docs.aws.amazon.com/opsworks/latest/userguide/security_iam_service-with-iam-opscm.html
   *
