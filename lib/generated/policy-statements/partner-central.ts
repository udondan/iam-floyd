...
/**
 * Statement provider for service [partnercentral](https://docs.aws.amazon.com/service-authorization/latest/reference/list_partner-central.html).
 *
...
export class Partnercentral extends PolicyStatement {
  ...
  /**
   * Grants permission to retrieve qualifications association details in AWS Partner Central
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/partner-central/latest/APIReference/API_account_GetQualificationsAssociationDetails.html
   */
  public toGetQualificationsAssociationDetails() {
    return this.to('GetQualificationsAssociationDetails');
  }

  /**
   * Grants permission to retrieve qualifications association task details in AWS Partner Central
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/partner-central/latest/APIReference/API_account_GetQualificationsAssociationTask.html
   */
  public toGetQualificationsAssociationTask() {
    return this.to('GetQualificationsAssociationTask');
  }

  /**
   * Grants permission to retrieve qualifications disassociation task details in AWS Partner Central
   *
   * Access Level: Read
   *
   * https://docs.aws.amazon.com/partner-central/latest/APIReference/API_account_GetQualificationsDisassociationTask.html
   */
  public toGetQualificationsDisassociationTask() {
    return this.to('GetQualificationsDisassociationTask');
  }
  ...
  /**
   * Grants permission to initiate tasks that start qualifications association in AWS Partner Central
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/partner-central/latest/APIReference/API_account_StartQualificationsAssociationTask.html
   */
  public toStartQualificationsAssociationTask() {
    return this.to('StartQualificationsAssociationTask');
  }

  /**
   * Grants permission to initiate tasks that start qualifications disassociation in AWS Partner Central
   *
   * Access Level: Write
   *
   * https://docs.aws.amazon.com/partner-central/latest/APIReference/API_account_StartQualificationsDisassociationTask.html
   */
  public toStartQualificationsDisassociationTask() {
    return this.to('StartQualificationsDisassociationTask');
  }
   ...
   * - .toGetQualificationsAssociationDetails()
   * - .toGetQualificationsAssociationTask()
   * - .toGetQualificationsDisassociationTask()
   * - .toGetRelationship()
   ...
   * - .toStartQualificationsAssociationTask()
   * - .toStartQualificationsDisassociationTask()
