...
/**
 * Statement provider for service [dms](https://docs.aws.amazon.com/service-authorization/latest/reference/list_dms.html).
 *
...
export class Dms extends PolicyStatement {
   ...
   * - .toCancelMetadataModelConversion()
   * - .toCancelMetadataModelCreation()
   ...
   * - .toDescribeMetadataModel()
   * - .toDescribeMetadataModelChildren()
   * - .toDescribeMetadataModelCreations()
