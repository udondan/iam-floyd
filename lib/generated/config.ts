...
export type ConfigActionsRead = 'BatchGetAggregateResourceConfig' | 'BatchGetResourceConfig' | 'DeliverConfigSnapshot' | 'DescribeConformancePackCompliance' | 'DescribeConformancePackStatus' | 'DescribeConformancePacks' | 'DescribeOrganizationConfigRuleStatuses' | 'DescribeOrganizationConfigRules' | 'DescribeOrganizationConformancePackStatuses' | 'DescribeOrganizationConformancePacks' | 'GetAggregateComplianceDetailsByConfigRule' | 'GetAggregateConfigRuleComplianceSummary' | 'GetAggregateDiscoveredResourceCounts' | 'GetAggregateResourceConfig' | 'GetComplianceDetailsByConfigRule' | 'GetComplianceDetailsByResource' | 'GetComplianceSummaryByConfigRule' | 'GetComplianceSummaryByResourceType' | 'GetConformancePackComplianceDetails' | 'GetConformancePackComplianceSummary' | 'GetDiscoveredResourceCounts' | 'GetOrganizationConfigRuleDetailedStatus' | 'GetOrganizationConformancePackDetailedStatus' | 'GetResourceConfigHistory' | 'SelectAggregateResourceConfig' | 'SelectResourceConfig';
export type ConfigActionsWrite = 'DeleteAggregationAuthorization' | 'DeleteConfigRule' | 'DeleteConfigurationAggregator' | 'DeleteConfigurationRecorder' | 'DeleteConformancePack' | 'DeleteDeliveryChannel' | 'DeleteEvaluationResults' | 'DeleteOrganizationConfigRule' | 'DeleteOrganizationConformancePack' | 'DeletePendingAggregationRequest' | 'DeleteRemediationConfiguration' | 'DeleteRemediationExceptions' | 'DeleteResourceConfig' | 'DeleteRetentionConfiguration' | 'PutAggregationAuthorization' | 'PutConfigRule' | 'PutConfigurationAggregator' | 'PutConfigurationRecorder' | 'PutConformancePack' | 'PutDeliveryChannel' | 'PutEvaluations' | 'PutOrganizationConfigRule' | 'PutOrganizationConformancePack' | 'PutRemediationConfigurations' | 'PutRemediationExceptions' | 'PutResourceConfig' | 'PutRetentionConfiguration' | 'StartConfigRulesEvaluation' | 'StartConfigurationRecorder' | 'StartRemediationExecution' | 'StopConfigurationRecorder';
export type ConfigActionsList = 'DescribeAggregateComplianceByConfigRules' | 'DescribeAggregationAuthorizations' | 'DescribeComplianceByConfigRule' | 'DescribeComplianceByResource' | 'DescribeConfigRuleEvaluationStatus' | 'DescribeConfigRules' | 'DescribeConfigurationAggregatorSourcesStatus' | 'DescribeConfigurationAggregators' | 'DescribeConfigurationRecorderStatus' | 'DescribeConfigurationRecorders' | 'DescribeDeliveryChannelStatus' | 'DescribeDeliveryChannels' | 'DescribePendingAggregationRequests' | 'DescribeRemediationConfigurations' | 'DescribeRemediationExceptions' | 'DescribeRemediationExecutionStatus' | 'DescribeRetentionConfigurations' | 'ListAggregateDiscoveredResources' | 'ListDiscoveredResources' | 'ListTagsForResource';
export type ConfigActionsTagging = 'TagResource' | 'UntagResource';
export type ConfigActions = ConfigActionsRead | ConfigActionsWrite | ConfigActionsList | ConfigActionsTagging;
