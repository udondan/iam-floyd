...
export type GameliftActionsWrite = 'AcceptMatch' | 'ClaimGameServer' | 'CreateAlias' | 'CreateBuild' | 'CreateFleet' | 'CreateGameServerGroup' | 'CreateGameSession' | 'CreateGameSessionQueue' | 'CreateMatchmakingConfiguration' | 'CreateMatchmakingRuleSet' | 'CreatePlayerSession' | 'CreatePlayerSessions' | 'CreateScript' | 'CreateVpcPeeringAuthorization' | 'CreateVpcPeeringConnection' | 'DeleteAlias' | 'DeleteBuild' | 'DeleteFleet' | 'DeleteGameServerGroup' | 'DeleteGameSessionQueue' | 'DeleteMatchmakingConfiguration' | 'DeleteMatchmakingRuleSet' | 'DeleteScalingPolicy' | 'DeleteScript' | 'DeleteVpcPeeringAuthorization' | 'DeleteVpcPeeringConnection' | 'DeregisterGameServer' | 'PutScalingPolicy' | 'RegisterGameServer' | 'ResumeGameServerGroup' | 'StartFleetActions' | 'StartGameSessionPlacement' | 'StartMatchBackfill' | 'StartMatchmaking' | 'StopFleetActions' | 'StopGameSessionPlacement' | 'StopMatchmaking' | 'SuspendGameServerGroup' | 'UpdateAlias' | 'UpdateBuild' | 'UpdateFleetAttributes' | 'UpdateFleetCapacity' | 'UpdateFleetPortSettings' | 'UpdateGameServer' | 'UpdateGameServerGroup' | 'UpdateGameSession' | 'UpdateGameSessionQueue' | 'UpdateMatchmakingConfiguration' | 'UpdateRuntimeConfiguration' | 'UpdateScript';
export type GameliftActionsRead = 'DescribeAlias' | 'DescribeBuild' | 'DescribeEC2InstanceLimits' | 'DescribeFleetAttributes' | 'DescribeFleetCapacity' | 'DescribeFleetEvents' | 'DescribeFleetPortSettings' | 'DescribeFleetUtilization' | 'DescribeGameServer' | 'DescribeGameServerGroup' | 'DescribeGameServerInstances' | 'DescribeGameSessionDetails' | 'DescribeGameSessionPlacement' | 'DescribeGameSessionQueues' | 'DescribeGameSessions' | 'DescribeInstances' | 'DescribeMatchmaking' | 'DescribeMatchmakingConfigurations' | 'DescribeMatchmakingRuleSets' | 'DescribePlayerSessions' | 'DescribeRuntimeConfiguration' | 'DescribeScalingPolicies' | 'DescribeScript' | 'DescribeVpcPeeringAuthorizations' | 'DescribeVpcPeeringConnections' | 'GetGameSessionLogUrl' | 'GetInstanceAccess' | 'RequestUploadCredentials' | 'ResolveAlias' | 'SearchGameSessions' | 'ValidateMatchmakingRuleSet';
export type GameliftActionsList = 'ListAliases' | 'ListBuilds' | 'ListFleets' | 'ListGameServerGroups' | 'ListGameServers' | 'ListScripts' | 'ListTagsForResource';
export type GameliftActionsTagging = 'TagResource' | 'UntagResource';
export type GameliftActions = GameliftActionsWrite | GameliftActionsRead | GameliftActionsList | GameliftActionsTagging;
