...
export type IotActionsPermissionsManagement = 'AttachPolicy' | 'AttachPrincipalPolicy' | 'DetachPolicy' | 'DetachPrincipalPolicy' | 'SetDefaultAuthorizer' | 'SetDefaultPolicyVersion';
...
export type IotActions = IotActionsWrite | IotActionsPermissionsManagement | IotActionsTagging | IotActionsRead | IotActionsList;
