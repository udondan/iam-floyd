...
export type StoragegatewayActionsWrite = 'ActivateGateway' | 'AddCache' | 'AddUploadBuffer' | 'AddWorkingStorage' | 'AssignTapePool' | 'AttachVolume' | 'BypassGovernanceRetention' | 'CancelArchival' | 'CancelRetrieval' | 'CreateCachediSCSIVolume' | 'CreateNFSFileShare' | 'CreateSMBFileShare' | 'CreateSnapshot' | 'CreateSnapshotFromVolumeRecoveryPoint' | 'CreateStorediSCSIVolume' | 'CreateTapePool' | 'CreateTapeWithBarcode' | 'CreateTapes' | 'DeleteAutomaticTapeCreationPolicy' | 'DeleteBandwidthRateLimit' | 'DeleteChapCredentials' | 'DeleteFileShare' | 'DeleteGateway' | 'DeleteSnapshotSchedule' | 'DeleteTape' | 'DeleteTapeArchive' | 'DeleteTapePool' | 'DeleteVolume' | 'DetachVolume' | 'DisableGateway' | 'JoinDomain' | 'NotifyWhenUploaded' | 'RefreshCache' | 'ResetCache' | 'RetrieveTapeArchive' | 'RetrieveTapeRecoveryPoint' | 'SetLocalConsolePassword' | 'SetSMBGuestPassword' | 'ShutdownGateway' | 'StartGateway' | 'UpdateAutomaticTapeCreationPolicy' | 'UpdateBandwidthRateLimit' | 'UpdateChapCredentials' | 'UpdateGatewayInformation' | 'UpdateGatewaySoftwareNow' | 'UpdateMaintenanceStartTime' | 'UpdateNFSFileShare' | 'UpdateSMBFileShare' | 'UpdateSnapshotSchedule' | 'UpdateVTLDeviceType';
export type StoragegatewayActionsTagging = 'AddTagsToResource' | 'RemoveTagsFromResource';
export type StoragegatewayActionsRead = 'DescribeBandwidthRateLimit' | 'DescribeCache' | 'DescribeCachediSCSIVolumes' | 'DescribeChapCredentials' | 'DescribeGatewayInformation' | 'DescribeMaintenanceStartTime' | 'DescribeNFSFileShares' | 'DescribeSMBFileShares' | 'DescribeSMBSettings' | 'DescribeSnapshotSchedule' | 'DescribeStorediSCSIVolumes' | 'DescribeTapeArchives' | 'DescribeTapeRecoveryPoints' | 'DescribeTapes' | 'DescribeUploadBuffer' | 'DescribeVTLDevices' | 'DescribeWorkingStorage';
export type StoragegatewayActionsList = 'ListAutomaticTapeCreationPolicies' | 'ListFileShares' | 'ListGateways' | 'ListLocalDisks' | 'ListTagsForResource' | 'ListTapePools' | 'ListTapes' | 'ListVolumeInitiators' | 'ListVolumeRecoveryPoints' | 'ListVolumes';
export type StoragegatewayActions = StoragegatewayActionsWrite | StoragegatewayActionsTagging | StoragegatewayActionsRead | StoragegatewayActionsList;
